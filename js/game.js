...
function initMap(){
  ...
  // Ajuster le zoom pour remplir le div sans répétition
...
function showMenu(){
  ...
  h.push('<div style="font-size:11px;color:#374151;letter-spacing:3px;margin-top:4px;margin-bottom:8px">v2.1</div>');
