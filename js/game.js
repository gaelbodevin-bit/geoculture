...
function showMenu(){
  ...
  h.push('<div style="display:grid;grid-template-columns:1fr 1fr 1fr 1fr;gap:5px">');
    h.push('<button id="btn-normal" onclick="selectGameMode(\'normal\')" style="background:#f97316;color:#fff;border:1px solid #f97316;border-radius:7px;padding:6px 2px;font-size:10px;font-weight:600;cursor:pointer;white-space:nowrap;overflow:hidden;text-overflow:ellipsis">Normal</button>');
    h.push('<button id="btn-nozoom" onclick="selectGameMode(\'nozoom\')" style="background:transparent;color:#f97316;border:1px solid #f97316;border-radius:7px;padding:6px 2px;font-size:10px;font-weight:600;cursor:pointer;white-space:nowrap;overflow:hidden;text-overflow:ellipsis">No-Zoom</button>');
    h.push('<button id="btn-perf" onclick="selectGameMode(\'perfection\')" style="background:transparent;color:#f97316;border:1px solid #f97316;border-radius:7px;padding:6px 2px;font-size:10px;font-weight:600;cursor:pointer;white-space:nowrap;overflow:hidden;text-overflow:ellipsis">Perfection</button>');
    h.push('<button id="btn-daily" onclick="showDailyMenu()" style="background:transparent;color:#fbbf24;border:1px solid #fbbf24;border-radius:7px;padding:6px 2px;font-size:10px;font-weight:600;cursor:pointer;white-space:nowrap;overflow:hidden;text-overflow:ellipsis">'+T('dailyChallenge')+'</button>');
  h.push('</div></div>');
