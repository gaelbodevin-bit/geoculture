const ROUNDS=[
  ...
  {name:"Alhambra ? Grenade, Espagne",lat:37.1761,lng:-3.5881,desc:"Ce palais nasride renferme l'une des plus belles décorations islamiques du monde. Ses jardins de l'Generalife, alimentés par un système hydraulique vieux de 700 ans, restent en fleur toute l'année.",hints:[
    ...
    {bc:"#3a2008",tc:"#fde68a",l:"MOYEN",t:"Chef-d'?uvre de l'architecture mauresque, le plus visité d'Espagne"},
  ...
  {name:"Big Ben ? Londres, Royaume-Uni",lat:51.5007,lng:-0.1246,desc:"Big Ben ne désigne pas la tour mais la cloche de 13,7 tonnes qu'elle abrite. Silenciée pour restauration de 2017 à 2022, elle a retenti à nouveau pour le couronnement de Charles III en mai 2023.",hints:[
    ...
    {bc:"#3d1a05",tc:"#fdba74",l:"DIFFICILE",t:"Quartier de Westminster, à 500m du 10 Downing Street, c?ur politique de la capitale"},
  ...
  {name:"Grande Muraille de Chine ? Mutianyu",lat:40.4319,lng:116.5704,desc:"Contrairement à la légende, la Grande Muraille n'est pas visible à l'?il nu depuis l'espace. Mais elle reste l'une des constructions humaines les plus longues avec ses 21 196 km, soit la moitié du périmètre de la Terre.",hints:[
  ...
  {name:"Temple d'or (Harmandir Sahib) ? Amritsar, Inde",lat:31.62,lng:74.8765,desc:"Le Temple d'Or recouvre 750 kg de feuilles d'or pur. Les Sikhs cuisinent et servent gratuitement 100 000 repas par jour à tous les visiteurs sans distinction de religion, de caste ou de nationalité.",hints:[
    ...
    {bc:"#3d1a05",tc:"#fdba74",l:"DIFFICILE",t:"C?ur de la vieille ville d'Amritsar, Pendjab indien, à 30 km de la frontière pakistanaise"},
  ...
  {name:"Marina Bay Sands ? Singapour",lat:1.2834,lng:103.8607,desc:"La piscine à débordement du Marina Bay Sands, à 200 m de hauteur, est la plus grande piscine en hauteur du monde avec ses 150 m de long. Elle ne relie les tours que visuellement ? elle est portée par une structure distincte de 10 000 tonnes.",hints:[
    ...
    {bc:"#3d1a05",tc:"#fdba74",l:"DIFFICILE",t:"Baie centrale de la cité-État, bord d'un détroit maritime, c?œur financier"},
  ...
  {name:"Uluru ? Territoire du Nord, Australie",lat:-25.3444,lng:131.0369,desc:"Uluru est beaucoup plus grand qu'il n'y paraît : les deux tiers de ce monolithe sont enfouis sous terre. Les Anangu ont finalement interdit l'escalade du rocher sacré en 2019, après des décennies de négociations.",hints:[
    ...
    {bc:"#3d1a05",tc:"#fdba74",l:"DIFFICILE",t:"C?œur du continent, région aride, à 450 km d'une ville isolée du désert"},
    {bc:"#3a2008",tc:"#fde68a",l:"MOYEN",t:"Grand rocher rouge sacré au c?ur du désert australien, classé UNESCO"},
  ...
  {name:"Basilique du Sacré-C?ur ? Paris, France",lat:48.8867,lng:2.3431,desc:"La basilique du Sacré-C?ur fut construite grâce à des souscriptions privées après la défaite de 1871 contre la Prusse ? un v?u national de repentir. Ses 83 mètres de hauteur sur la Butte Montmartre en font le point culminant de Paris, visible de presque partout dans la ville.",hints:[
    ...
    {bc:"#052e16",tc:"#86efac",l:"FACILE",t:"La Basilique du Sacré-C?ur à Paris, France"}
  ]},
  ...
  {name:"Fjord de Geiranger ? Norvège",lat:62.1006,lng:7.2051,desc:"Les 7 cascades des «Sept S?urs» dans le fjord de Geiranger sont alimentées uniquement par la fonte des neiges et la pluie ? il n'y a aucune source ni aucun lac en amont. En face se trouve la cascade du Prétendant qui semble «arroser» les sept s?urs.",hints:[
    {bc:"#3b0f0f",tc:"#fca5a5",l:"EXPERT",t:"Geirangerfjord, 15 km de long, classé UNESCO, célèbre pour les cascades des Sept S?urs et du Voile de la Mariée"},
  ...
  {name:"Canal de Panama",lat:9.0798,lng:-79.6816,desc:"Le canal de Panama raccourcit de 15 000 km le trajet entre les océans Atlantique et Pacifique. Sa construction coûta la vie à 25 000 ouvriers entre 1881 et 1914, principalement à cause de la malaria et de la fièvre jaune.",hints:[
    ...
    {bc:"#3a2008",tc:"#fde68a",l:"MOYEN",t:"Canal reliant l'Atlantique au Pacifique, grande ?uvre du XXe siècle"},
  ...
  {name:"Times Square ? New York, USA",lat:40.758,lng:-73.9855,desc:"Times Square doit son nom au New York Times qui y installa son siège en 1904 et y fit tomber pour la première fois la «ball drop» du Nouvel An. Avec 50 millions de visiteurs par an, c'est le lieu le plus cher pour la publicité au monde ? un panneau peut coûter 50 000 dollars par jour.",hints:[
    ...
    {bc:"#3a2008",tc:"#fde68a",l:"MOYEN",t:"Carrefour des néons, c?ur de Manhattan, New York"},
  ...
  {name:"Bibliothèque de l'Université d'Helsinki ? Finlande",lat:60.1699,lng:24.9384,desc:"La bibliothèque nationale de Finlande, bâtie en 1840 par Carl Ludwig Engel, est le chef-d'?uvre néoclassique d'Helsinki. Son architecture sobre et majestueuse fut conçue pour rivaliser avec les grandes bibliothèques européennes. Elle abrite un exemplaire de chaque livre publié en Finlande depuis 1707 ? un dépôt légal exceptionnel.",hints:[
    ...
    {bc:"#3d1a05",tc:"#fdba74",l:"DIFFICILE",t:"Senate Square (Senaatintori), c?œur de la capitale la plus nordique d'Europe continentale"},
  ...
  {name:"Place Wenceslas ? Prague, Rép. Tchèque",lat:50.0813,lng:14.4281,desc:"La place Venceslas de Prague n'est pas une place mais un boulevard de 750 mètres. C'est le centre politique de la Bohême depuis le Moyen Âge. Jan Palach s'y immola par le feu en 1969 pour protester contre l'invasion soviétique. En 1989, des centaines de milliers de personnes y manifestèrent lors de la Révolution de velours.",hints:[
    {bc:"#3b0f0f",tc:"#fca5a5",l:"EXPERT",t:"Václavské nám?stí, boulevard de 750m, c?ur politique des révolutions de 1848, 1968 et 1989 (Révolution de velours)"},
    {bc:"#3d1a05",tc:"#fdba74",l:"DIFFICILE",t:"Nové M?sto (Nouvelle Ville), centre de Prague, entre la gare centrale et le musée national"},
    {bc:"#3a2008",tc:"#fde68a",l:"MOYEN",t:"Grande place-boulevard au c?ur de Prague, témoin de la Révolution de Velours"},
  ...
  {name:"Désert du Sahara ? Algérie (Tassili)",lat:25.4167,lng:8.4167,desc:"Le Tassili n'Ajjer en Algérie est un vaste plateau rocheux abritant 15 000 peintures et gravures rupestres réalisées entre -10 000 et -2 000 av. J.-C. Ces ?uvres représentent des éléphants, hippopotames et crocodiles ? preuve que le Sahara était autrefois une savane verdoyante. L'UNESCO le classe double patrimoine naturel et culturel.",hints:[
  ...
  {name:"Piazza San Marco ? Venise, Italie",lat:45.4341,lng:12.3388,desc:"La place Saint-Marc de Venise est la seule place de la ville que Napoléon appela «le plus beau salon de l'Europe». Ses 200 millions de visiteurs par an l'inondent régulièrement ? la place est submergée lors des marées hautes (acqua alta). Son campanile, effondré en 1902, fut reconstruit identique et réouvert le 25 avril 1912, jour anniversaire de sa chute.",hints:[
    ...
    {bc:"#3a2008",tc:"#fde68a",l:"MOYEN",t:"Place Saint-Marc, c?ur de Venise, basilique byzantine et campanile"},
  ...
  {name:"Parc de Blenheim ? Oxfordshire, Royaume-Uni",lat:51.8414,lng:-1.3617,desc:"Le palais de Blenheim est le seul palais non royal d'Angleterre ? offert par la nation au duc de Marlborough après sa victoire à Blenheim en 1704. Winston Churchill y naquit en 1874. Son parc, dessiné par Capability Brown, est considéré comme le chef-d'?uvre du paysagisme anglais naturel.",hints:[
  ...
  {name:"Hofburg ? Vienne, Autriche",lat:48.2066,lng:16.3656,desc:"Le Hofburg, résidence des Habsbourg pendant 600 ans, est un labyrinthe de 2 600 pièces construit du XIIIe au XXe siècle. Il abrite les joyaux de la couronne des Habsbourg, les Lipizzans de l'École espagnole d'équitation et les appartements de Sissi. Aujourd'hui siège de la présidence autrichienne, il reste ouvert aux visites.",hints:[
    ...
    {bc:"#3a2008",tc:"#fde68a",l:"MOYEN",t:"Palais impérial habsbourgeois au c?ur de Vienne, Autriche"},
  ...
  {name:"Lac de Bled ? Slovénie",lat:46.3683,lng:14.0933,desc:"Le lac de Bled est la seule île naturelle de Slovénie. La tradition veut que les mariés rament jusqu'à l'île, que l'époux porte sa femme sur les 99 marches menant à l'église et sonne la cloche aux v?ux pour un mariage heureux.",hints:[
    {bc:"#3b0f0f",tc:"#fca5a5",l:"EXPERT",t:"Lac glaciaire aux eaux émeraude, île au c?ur du lac avec l'église Marie-Mère de Dieu (1465), château du XIe siècle"},
  ...
  {name:"Katmandou ? Népal (Bodnath)",lat:27.7215,lng:85.362,desc:"Le stupa de Boudhanath est le plus grand d'Asie du Sud et le c?ur spirituel de la communauté tibétaine en exil au Népal. Ses 13 anneaux dorés symbolisent les étapes vers l'éveil bouddhiste. Entouré de 50 monastères tibétains, il reste l'un des sites de pèlerinage les plus actifs du bouddhisme vajrayana.",hints:[
  ...
  {name:"Tenochtitlan ? Mexico, Mexique",lat:19.4342,lng:-99.1333,desc:"Tenochtitlan, capitale aztèque fondée en 1325 sur une île au milieu du lac Texcoco, était la plus grande ville d'Amérique précolombienne. Elle fut détruite par Cortés en 1521 et le lac fut asséché. Mexico fut construite directement au-dessus ? le Zócalo actuel se trouve exactement sur l'ancienne place centrale aztèque.",hints:[
    {bc:"#3b0f0f",tc:"#fca5a5",l:"EXPERT",t:"Templo Mayor aztèque, fouilles depuis 1978, grand temple à deux sanctuaires (Huitzilopochtli et Tlaloc), au c?ur de la capitale pr"},
    {bc:"#3d1a05",tc:"#fdba74",l:"DIFFICILE",t:"Centro Histórico d'une mégalopole, grande place centrale, c?œur de l'ancienne Tenochtitlan"},
    {bc:"#3a2008",tc:"#fde68a",l:"MOYEN",t:"Templo Mayor aztèque, c?ur de l'ancienne capitale aztèque, Mexico"},
  ...
  {name:"Choquequirao ? Pérou",lat:-13.5393,lng:-72.8498,desc:"Choquequirao est parfois surnommée «Machu Picchu de luxe» car elle n'est accessible qu'à pied après 2 jours de marche. Sa taille égale celle de Machu Picchu mais elle accueille seulement 30 visiteurs par jour contre 5 000. Un projet de téléphérique menace d'en faire la prochaine destination de masse du Pérou.",hints:[
    ...
    {bc:"#3a2008",tc:"#fde68a",l:"MOYEN",t:"Cité inca dans les nuages accessible uniquement à pied, s?ur oubliée d'une célèbre cité andine, Pérou"},
  ...
  {name:"Île de Moorea ? Polynésie française",lat:-17.5327,lng:-149.8322,desc:"L'île de Moorea, visible depuis Tahiti à 17 km, est un ancien volcan dont le cratère effondré forma deux baies en forme de c?ur. Le biologiste James Cook l'appela «l'Île de la paix». Jacques Brel y vécut ses dernières années dans les années 1970, naviguant entre ses îles adorées dans son voilier.",hints:[
    {bc:"#3b0f0f",tc:"#fca5a5",l:"EXPERT",t:"Île de basalte s?ur de Tahiti, piques volcaniques du Mont Rotui (899m), baies d'Opunohu et de Cook, requins dormeurs"},
    {bc:"#3d1a05",tc:"#fdba74",l:"DIFFICILE",t:"À 17 km à l'ouest de Tahiti, archipel de la Société, Polynésie française, Pacifique Sud"},
    {bc:"#3a2008",tc:"#fde68a",l:"MOYEN",t:"Moorea, île s?ur de Tahiti aux piques volcaniques, Polynésie française"},
  ...
  {name:"Cathédrale Notre-Dame de Chartres ? France",lat:48.4469,lng:1.4886,desc:"La cathédrale de Chartres est l'une des rares à avoir conservé ses vitraux médiévaux d'origine. Pendant la Seconde Guerre mondiale, les Chartranais déposèrent les 176 vitraux et les enfouirent dans des caisses dans des caves pour les protéger des bombardements.",hints:[
    {bc:"#3b0f0f",tc:"#fca5a5",l:"EXPERT",t:"Chef-d'?uvre gothique consacré en 1220, 176 vitraux médiévaux dont la célèbre rose nord, Eure-et-Loir"},
  ...
  {name:"Abbaye du Mont Cassin ? Italie",lat:41.4895,lng:13.8138,desc:"L'acoustique de l'abbaye du Thoronet est si parfaite que les moines cisterciens pouvaient chanter a cappella dans la nef sans aucun équipement d'amplification. Le musicien américain Jonathan Harvey y composa une ?uvre inspirée par sa réverbération de 1,8 secondes.",hints:[
  ...
  {name:"Cathédrale de Durham ? Royaume-Uni",lat:54.7733,lng:-1.5762,desc:"La cathédrale de Durham, avec ses colonnes à zigzag normandes, fut choisie par le magazine Time comme le bâtiment le plus grandiose jamais construit. Sa position sur un promontoire au-dessus de la Wear et sa masse austère en font l'un des paysages les plus dramatiques d'Angleterre.",hints:[
    {bc:"#3b0f0f",tc:"#fca5a5",l:"EXPERT",t:"Chef-d'?uvre roman normand commencé en 1093, abritant les reliques de Saint-Cuthbert et Bède le Vénérable, promontoire sur la Wear"},
  ...
  {name:"Portofino ? Ligurie, Italie",lat:44.3031,lng:9.2097,desc:"Portofino, village de 500 habitants, est l'une des destinations les plus chères d'Europe. Ses maisons en trompe-l'?il ? la façade peinte de fenêtres, balcons et décors imaginaires ? sont une tradition ligure vieille de plusieurs siècles. Un week-end de location dans l'une de ces maisons peut coûter autant qu'une voiture.",hints:[
    {bc:"#3b0f0f",tc:"#fca5a5",l:"EXPERT",t:"Village de pêcheurs aux maisons peintes en trompe-l'?il, Castello Brown (1870), Piazzetta centro mondain, golfe du Tigullio"},
    {bc:"#3d1a05",tc:"#fdba74",l:"DIFFICILE",t:"Promontoire de Portofino, province de Gênes, Ligurie, mer Ligure"},
    {bc:"#3a2008",tc:"#fde68a",l:"MOYEN",t:"Petit village de pêcheurs aux maisons en trompe-l'?il, golfe du Tigullio, Riviera ligure"},
  ...
  {name:"Abbaye de Fontevraud ? France",lat:47.1784,lng:0.053,desc:"L'abbaye de Fontevraud est la plus grande abbaye médiévale de France. Elle renferme les gisants de Richard C?ur de Lion, Aliénor d'Aquitaine et Henri II Plantagenêt. Transformée en prison napoléonienne de 1804 à 1963, elle garde encore les cellules dans sa nef ? un mélange saisissant du sacré et du carcéral.",hints:[
    {bc:"#3b0f0f",tc:"#fca5a5",l:"EXPERT",t:"Fondée en 1101 par Robert d'Arbrissel, nécropole des Plantagenêts dont Richard C?ur de Lion, plus grand ensemble monastique"},
    {bc:"#3d1a05",tc:"#fdba74",l:"DIFFICILE",t:"Commune de Fontevraud-l'Abbaye, Maine-et-Loire, à 15 km de Saumur, val de Loire"},
    {bc:"#3a2008",tc:"#fde68a",l:"MOYEN",t:"Plus grande abbaye médiévale de France, nécropole des Plantagenêts dont Richard C?ur de Lion, Maine-et-Loire"},
  ...
  {name:"Abbaye du Thoronet ? Provence, France",lat:43.4699,lng:6.3193,desc:"L'acoustique de l'abbaye du Thoronet est si parfaite que les moines cisterciens pouvaient chanter a cappella dans la nef sans aucun équipement d'amplification. Le musicien américain Jonathan Harvey y composa une ?uvre inspirée par sa réverbération de 1,8 secondes.",hints:[
  ...
  {name:"Palerme ? Sicile (Cappella Palatina)",lat:38.1111,lng:13.3554,desc:"La Cappella Palatina de Palerme (1143) est un chef-d'?uvre de l'art normanno-arabe-byzantin : ses mosaïques dorées byzantines recouvrent des plafonds en bois de style islamique avec des inscriptions en arabe ? un syncrétisme culturel unique du règne de Roger II de Sicile.",hints:[
  ...
  {name:"Ouro Preto ? Minas Gerais, Brésil",lat:-20.3867,lng:-43.5036,desc:"Ouro Preto (or brut) fut l'épicentre de la ruée vers l'or du XVIIIe siècle qui fit du Brésil le premier producteur mondial. La ville draina tellement de richesses que le Portugal put financer la reconstruction de Lisbonne après le tremblement de terre de 1755.",hints:[
    ...
    {bc:"#3a2008",tc:"#fde68a",l:"MOYEN",t:"Ville baroque de l'or du XVIIIe siècle, 13 églises dont le chef-d'?uvre de l'Aleijadinho, UNESCO, Minas Gerais"},
  ...
  {name:"Blue Mountains ? Nouvelle-Galles du Sud, Australie",lat:-33.719,lng:150.3113,desc:"Les Blue Mountains doivent leur teinte bleutée à la brume d'huile essentielle d'eucalyptus qui flotte en permanence dans l'air. Les 5 millions d'eucalyptus libèrent une huile volatile qui disperse la lumière bleue ? un phénomène optique unique à cette région.",hints:[
    ...
    {bc:"#3a2008",tc:"#fde68a",l:"MOYEN",t:"Plateau aux falaises de grès avec brume bleue d'eucalyptus, formations des Trois S?urs, Nouvelle-Galles du Sud"},
