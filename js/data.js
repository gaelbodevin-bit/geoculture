const ROUNDS=[
  ...
  {name:"Notre-Dame de Paris — France",lat:48.853,lng:2.3499,desc:"Joyau du gothique français, Notre-Dame a failli disparaître lors de l'incendie d'avril 2019. Sa reconstruction mobilisa des artisans du monde entier et elle a rouvert ses portes en décembre 2024.",hints:[
  ...
  {name:"Colisée — Rome, Italie",lat:41.8902,lng:12.4922,desc:"L'amphithéâtre le plus grand de l'Antiquité pouvait se remplir d'eau pour simuler des batailles navales. Ses 80 sorties permettaient d'évacuer 80 000 spectateurs en moins de 10 minutes.",hints:[
    ...
    {bc:"#052e16",tc:"#86efac",l:"FACILE",t:"Colosseo — amphithéâtre oval dans le centre de Rome, visible depuis le Forum Romain"},
  ...
  {name:"Big Ben — Londres, Royaume-Uni",lat:51.5007,lng:-0.1246,desc:"Big Ben ne désigne pas la tour mais la cloche de 13,7 tonnes qu'elle abrite. Silenciée pour restauration de 2017 à 2022, elle a retenti à nouveau pour le couronnement de Charles III en mai 2023.",hints:[
    ...
    {bc:"#052e16",tc:"#86efac",l:"FACILE",t:"Westminster, Londres, bord de la Tamise — horloge emblématique du parlement britannique"},
  ...
  {name:"Stonehenge — Wiltshire, Royaume-Uni",lat:51.1789,lng:-1.8262,desc:"Stonehenge fut édifié en trois phases entre -3000 et -1500 av. J.-C. Les plus grandes pierres pesant 25 tonnes furent transportées depuis le Pays de Galles sur 250 km, probablement à l'aide de traîneaux, de rondins et de rivières.",hints:[
    ...
    {bc:"#052e16",tc:"#86efac",l:"FACILE",t:"Plaine du Wiltshire, Angleterre — cercle de mégaliths préhistoriques classé UNESCO"},
  ...
  {name:"Rijksmuseum — Amsterdam, Pays-Bas",lat:52.36,lng:4.8852,desc:"La «Ronde de nuit» de Rembrandt mesure 3,6 m × 4,3 m. Pour la déplacer lors d'une restauration en 1975, les autorités néerlandaises percèrent une porte spéciale dans le mur du musée.",hints:[
  ...
  {name:"Tour de Pise — Italie",lat:43.723,lng:10.3966,desc:"La Tour de Pise penche depuis sa deuxième phase de construction au XIIe siècle, à cause d'un sol trop mou d'un côté. Des travaux de 1990 à 2001 ont réduit l'inclinaison de 44 cm pour la stabiliser pour les 200 prochaines années.",hints:[
  ...
  {name:"Temple d'or (Harmandir Sahib) — Amritsar, Inde",lat:31.62,lng:74.8765,desc:"Le Temple d'Or recouvre 750 kg de feuilles d'or pur. Les Sikhs cuisinent et servent gratuitement 100 000 repas par jour à tous les visiteurs sans distinction de religion, de caste ou de nationalité.",hints:[
  ...
  {name:"Petra — Jordanie",lat:30.3285,lng:35.4444,desc:"Le canyon du Siq, gorge menant à Petra, mesure par endroits moins d'un mètre de large pour 80 mètres de haut. Les touristes qui marchent dans cette fissure rouge au lever du soleil émergent sur le Trésor — un moment considéré comme l'un des plus beaux au monde.",hints:[
    ...
    {bc:"#052e16",tc:"#86efac",l:"FACILE",t:"Désert rouge de Jordanie — cité nabtéenne taillée dans la roche rosée"},
  ...
  {name:"Sphinx de Gizeh — Égypte",lat:29.9753,lng:31.1376,desc:"Le nez du Sphinx fut probablement brisé intentionnellement au XVe siècle. Des photographies du XIXe siècle montrent que le Sphinx était recouvert jusqu'aux épaules par les sables du désert pendant des siècles.",hints:[
    ...
    {bc:"#052e16",tc:"#86efac",l:"FACILE",t:"Plateau de Gizeh, Égypte — gardien à tête humaine des pyramides depuis 4 500 ans"},
    {bc:"#0c1a3e",tc:"#93c5fd",l:"TRÈS FACILE",t:"Capitale de l'Égypte"}
  ]},
  {name:"Kilimandjaro — Tanzanie",lat:-3.0674,lng:37.3556,desc:"Le Kilimandjaro perd 80% de sa calotte glaciaire depuis 1912 en raison du réchauffement climatique. Ses glaciers sommitaux pourraient disparaître complètement d'ici 2060, menaçant l'approvisionnement en eau de millions d'Africains.",hints:[
    ...
    {bc:"#052e16",tc:"#86efac",l:"FACILE",t:"Nord-est de la Tanzanie — plus haute montagne d'Afrique, volcan couvert de glaciers"},
  ...
  {name:"Statue de l'Unité — Inde (Sardar Patel)",lat:21.8381,lng:73.7198,desc:"La Statue de l'Unité représente Sardar Vallabhbhai Patel, l'homme qui réunit les 562 principautés indiennes en un seul État après l'indépendance. À 182 mètres, elle est deux fois plus haute que la Statue de la Liberté. Des visiteurs viennent du monde entier pour monter jusqu'à son torse-observatoire.",hints:[
    ...
    {bc:"#052e16",tc:"#86efac",l:"FACILE",t:"Gujarat, Inde — plus haute statue du monde (182m), visible depuis le barrage de Sardar Sarovar"},
  ...
  {name:"Machu Picchu — Pérou",lat:-13.1631,lng:-72.545,desc:"Machu Picchu fut construit sans roue, sans fer et sans écriture. Ses murs en pierre sèche résistent aux séismes car chaque bloc est légèrement arrondi, permettant aux pierres de «danser» lors des tremblements de terre.",hints:[
  ...
  {name:"Chichen Itza — Yucatan, Mexique",lat:20.6843,lng:-88.5678,desc:"La grande cénote sacrée de Chichen Itza livra lors de fouilles au XXe siècle des dizaines de squelettes, bijoux de jade et objets en or — confirmant les sacrifices mayas. On estime que des milliers d'offrandes reposent encore au fond inaccessible du puits.",hints:[
    ...
    {bc:"#052e16",tc:"#86efac",l:"FACILE",t:"Yucatán, Mexique — pyramide maya de Kukulcán, phénomène du serpent de lumière aux équinoxes"},
  ...
  {name:"Opéra de Sydney — Australie",lat:-33.8568,lng:151.2153,desc:"La construction de l'Opéra de Sydney prit 16 ans et coûta 14 fois son budget initial. Pour financer le dépassement, le gouvernement australien créa une loterie nationale spéciale. Les billets de loterie «Sydney Opera House» sont aujourd'hui des pièces de collection.",hints:[
    ...
    {bc:"#052e16",tc:"#86efac",l:"FACILE",t:"Port de Sydney, Australie — opéra aux voiles blanches en béton, baie de Bennelong Point"},
  ...
  {name:"Palais du Parlement — Budapest, Hongrie",lat:47.5072,lng:19.0461,desc:"Le Parlement de Budapest est illuminé chaque nuit et se reflète dans le Danube — l'une des plus belles vues nocturnes d'Europe. Sa construction dura 17 ans (1885-1902) et employa 100 000 ouvriers et 40 millions de briques.",hints:[
    ...
    {bc:"#052e16",tc:"#86efac",l:"FACILE",t:"Budapest, Hongrie — palais du parlement néogothique au bord du Danube, symbole de la nation"},
  ...
  {name:"Château de Prague — République Tchèque",lat:50.0902,lng:14.4,desc:"Le complexe du château de Prague est l'un des plus grands du monde avec ses 70 000 m². Il abrite une cathédrale, un palais royal, un couvent, des jardins et une ruelle d'or où vivaient jadis les alchimistes de Rodolphe II qui cherchaient à transmuer le plomb en or.",hints:[
    {bc:"#3b0f0f",tc:"#fca5a5",l:"EXPERT",t:"Hradĝany, plus grand château du monde en superficie (70 000 m²), érigé au IXe siècle sur le Hradschin"},
    {bc:"#3d1a05",tc:"#fdba74",l:"DIFFICILE",t:"Colline de Hradĝany dominant la Vltava, quartier Malá Strana, Prague"},
    {bc:"#3a2008",tc:"#fde68a",l:"MOYEN",t:"Plus grand château du monde, résidence présidentielle tchèque"},
    {bc:"#052e16",tc:"#86efac",l:"FACILE",t:"Prague, République Tchèque — château médiéval dominant la Vltava depuis la colline de Hradĝany"},
  ...
  {name:"Sagrada Família — Barcelone",lat:41.4036,lng:2.1744,desc:"Gaudí consacra les 43 dernières années de sa vie à cette cathédrale. Renversé par un tramway en 1926, il fut enterré dans sa propre église. La construction, financée uniquement par les entrées des visiteurs, devrait s'achever en 2026.",hints:[
    ...
    {bc:"#052e16",tc:"#86efac",l:"FACILE",t:"Barcelone, Espagne — parc Güell ou Sagrada Família, archi Gaudí"},
  ...
  {name:"Canal Grande — Venise, Italie",lat:45.4408,lng:12.3155,desc:"Le Grand Canal de Venise compte 150 palais construits entre le XIIIe et le XVIIIe siècle sur ses 3,8 km. Ces bâtiments s'enfoncent progressivement — Venise s'est affaissée de 23 cm au XXe siècle — ce qui poussa à lancer le projet MOSE, un système de digues mobiles anti-inondations.",hints:[
    ...
    {bc:"#052e16",tc:"#86efac",l:"FACILE",t:"Venise, Italie — grand canal en S traversé par le pont du Rialto, cité lagunaire"},
  ...
  {name:"Thermes de Caracalla — Rome, Italie",lat:41.8788,lng:12.4922,desc:"Les thermes de Caracalla furent fermés définitivement en 537 quand les Ostrogoths coupèrent les aqueducs de Rome. Depuis les années 1930, l'Opéra de Rome y organise des spectacles en plein air — des représentations de Verdi ou Puccini dans ce décor antique imposant.",hints:[
    ...
    {bc:"#052e16",tc:"#86efac",l:"FACILE",t:"Centre historique de Rome, entre le Forum et le Palatin, bord du Tibre"},
    {bc:"#0c1a3e",tc:"#93c5fd",l:"TRÈS FACILE",t:"Italie"}
  ]},
  ...
  {name:"Tour de Belém — Lisbonne, Portugal",lat:38.6916,lng:-9.216,desc:"La tour de Belém fut construite en 1516 au bord du Tage pour saluer les explorateurs partant vers les Indes. Ce joyau manuélin est orné de motifs marins, de nœuds de corde en pierre et de la sphère armillaire, emblème du Portugal des grandes découvertes.",hints:[
    ...
    {bc:"#052e16",tc:"#86efac",l:"FACILE",t:"Belem, Lisbonne, Portugal — tour médiévale à l'embouchure du Tage, style manuelin"},
  ...
  {name:"Atomium — Bruxelles, Belgique",lat:50.8947,lng:4.3411,desc:"L'Atomium de Bruxelles représente une maille de cristal de fer agrandie 165 milliards de fois. Conçu comme une attraction temporaire pour l'Expo 58, il fut maintenu après l'exposition suite à son succès populaire. Ses sphères intérieures accueillent des expositions et même un appartement loué.",hints:[
    ...
    {bc:"#052e16",tc:"#86efac",l:"FACILE",t:"Centre de Bruxelles, Belgique — structure moléculaire géante construite pour l'Expo 1958"},
  ...
  {name:"Château de Édimbourg — Écosse, Royaume-Uni",lat:55.9486,lng:-3.2008,desc:"Le château d'Édimbourg est bâti sur un rocher volcanique vieux de 340 millions d'années. Il abrite les Honneurs d'Écosse — la plus ancienne couronne royale d'Europe en service, datant de 1540. Son canon «One O'Clock Gun» tire chaque jour à 13h précises depuis 1861, une tradition débutée pour les marins du port de Leith.",hints:[
    ...
    {bc:"#052e16",tc:"#86efac",l:"FACILE",t:"Édinbourg, Écosse — forteresse royale dominant la vieille ville depuis un rocher volcanique"},
  ...
  {name:"Château de Hohenzollern — Allemagne",lat:48.3219,lng:8.943,desc:"Le château de Hohenzollern fut reconstruit trois fois au même endroit. La version actuelle, néogothique, date de 1867. Il abrite la couronne de Prusse et l'uniforme dans lequel Frédéric le Grand mourut — des reliques du royaume prussien qui unifia l'Allemagne.",hints:[
    ...
    {bc:"#052e16",tc:"#86efac",l:"FACILE",t:"Allemagne — massif boisé de sapins et ravines, célèbre pour le gâteau et les horloges coucou"},
  ...
  {name:"Opéra Garnier — Paris, France",lat:48.8719,lng:2.3316,desc:"L'Opéra Garnier abrite un véritable lac souterrain, créé involontairement lors de la construction pour drainer les eaux de la nappe phréatique. Ce lac, utilisé pour entraîner les pompiers à la nage, inspira directement Gaston Leroux pour son roman «Le Fantôme de l'Opéra» en 1910.",hints:[
    ...
    {bc:"#052e16",tc:"#86efac",l:"FACILE",t:"Paris, France — opéra néo-baroque du XIXe siècle, 2 000 places, escalier monumental"},
    {bc:"#0c1a3e",tc:"#93c5fd",l:"TRÈS FACILE",t:"France"}
  ]},
  {name:"Temple Sensŝ-ji — Tokyo, Japon",lat:35.7148,lng:139.7967,desc:"Le temple Senso-ji d'Asakusa est le plus ancien et le plus visité de Tokyo avec 30 millions de visiteurs par an. La Nakamise-dori, la rue commerçante menant au temple, vend des souvenirs depuis l'époque Edo. Les marchands actuels sont souvent les descendants directs des premiers commerçants du XVIIe siècle.",hints:[
    {bc:"#3b0f0f",tc:"#fca5a5",l:"EXPERT",t:"Senso-ji, plus ancien temple de la mégalopole, fondé en 628, dédié à Kannon, quartier d'Asakusa, Taitŝ"},
    {bc:"#3d1a05",tc:"#fdba74",l:"DIFFICILE",t:"Nakamise-dŝri, quartier d'Asakusa, arrondissement de Taitŝ"},
    {bc:"#3a2008",tc:"#fde68a",l:"MOYEN",t:"Plus ancien et plus visité temple bouddhiste de Tokyo"},
    {bc:"#052e16",tc:"#86efac",l:"FACILE",t:"Asakusa, Tokyo — plus vieux temple de la ville, porte Kaminarimon aux lanternes rouges"},
  ...
  {name:"Temple d'Or — Kyoto, Japon",lat:35.0394,lng:135.7292,desc:"Le Temple d'Or recouvre 750 kg de feuilles d'or pur. Les Sikhs cuisinent et servent gratuitement 100 000 repas par jour à tous les visiteurs sans distinction de religion, de caste ou de nationalité.",hints:[
    ...
    {bc:"#3d1a05",tc:"#fdba74",l:"DIFFICILE",t:"Quartier Kita-ku, nord de Kyoto, surplombant l'étang Kyŝko-chi"},
    {bc:"#3a2008",tc:"#fde68a",l:"MOYEN",t:"Pavillon doré du temple Kinkaku-ji, emblème de Kyoto, Japon"},
    {bc:"#052e16",tc:"#86efac",l:"FACILE",t:"Kyoto, Japon — pavillon d'or recouvert de feuilles d'or, reflet dans l'étang Kyoko-chi"},
    {bc:"#0c1a3e",tc:"#93c5fd",l:"TRÈS FACILE",t:"Japon"}
  ]},
  ...
  {name:"Temple de Borobudur — Java, Indonésie",lat:-7.6079,lng:110.2038,desc:"Le temple de Borobudur fut enseveli sous les cendres volcaniques et la végétation pendant 800 ans. Il fut redécouvert par Sir Thomas Raffles en 1814 et restauré dans les années 1970 dans le cadre du plus grand projet de restauration jamais entrepris par l'UNESCO.",hints:[
    ...
    {bc:"#052e16",tc:"#86efac",l:"FACILE",t:"Java, Indonésie — plus grand temple bouddhiste du monde, 9 étages de stupas"},
  ...
  {name:"Temple de Preah Vihear — Cambodge",lat:14.3924,lng:104.6804,desc:"Le temple de Preah Vihear fit l'objet d'un différend territorial entre le Cambodge et la Thaïlande pendant des décennies. En 2013, la Cour internationale de justice confirma la souveraineté cambodgienne — une victoire symbolique pour un pays qui souhaitait aussi faire classer le site à l'UNESCO.",hints:[
    ...
    {bc:"#052e16",tc:"#86efac",l:"FACILE",t:"Siem Reap, Cambodge — plus grand temple du monde, chef-d'oeuvre de l'empire khmer"},
  ...
  {name:"Palais de Mysore — Inde",lat:12.3052,lng:76.6552,desc:"Le palais de Mysore est illuminé par 97 000 ampoules chaque dimanche soir et lors des fêtes religieuses. Ce spectacle attire des millions de visiteurs et du palais brille depuis la ville comme une étoile. La famille royale des Wadiyar vit encore dans une partie du complexe.",hints:[
    ...
    {bc:"#052e16",tc:"#86efac",l:"FACILE",t:"Karnataka, Inde — palais de Mysore illuminé de 100 000 ampoules les dimanches"},
  ...
  {name:"Rocher de Sigiriya — Sri Lanka",lat:7.957,lng:80.7603,desc:"Le Rocher de Sigiriya abrite 500 fresques de femmes célestes (apsaras) dont seulement 22 ont survécu aux intempéries. Ce sont parmi les seules peintures laïques à grande échelle du 5e siècle encore visibles dans le monde.",hints:[
  ...
  {name:"Cités de Lalibela — Éthiopie",lat:12.0317,lng:39.0448,desc:"Les 11 églises de Lalibela furent taillées à même le roc en seulement 24 ans au XIIe siècle. Selon la légende, les anges travaillaient la nuit pendant que les hommes se reposaient, permettant un avancement miraculeux du chantier.",hints:[
    ...
    {bc:"#052e16",tc:"#86efac",l:"FACILE",t:"Éthiopie — 11 églises chrétiennes taillées dans le roc, pelegrinage chrétien orthodoxe"},
  ...
  {name:"Chutes d'Iguazu — Argentine/Brésil",lat:-25.6953,lng:-54.4367,desc:"Les chutes d'Iguazu sont si larges que Eleanor Roosevelt s'écria «Poor Niagara!» en les voyant pour la première fois. Elles forment la frontière naturelle entre l'Argentine et le Brésil, et les deux pays se disputèrent leur souveraineté pendant des décennies.",hints:[
    ...
    {bc:"#052e16",tc:"#86efac",l:"FACILE",t:"Frontière Argentine-Brésil — 275 chutes d'eau dont la Garganta del Diablo, 2,7 km de large"},
  ...
  {name:"Désert du Namib — Namibie",lat:-24.7333,lng:15.5167,desc:"Le désert du Namib est le plus ancien désert du monde — aride depuis au moins 55 millions d'années. Son «Deadlei» (marais mort) abrite des squelettes d'arbres camelthorn de 900 ans, conservés par la sécheresse extrême. Ses dunes de Sossusvlei, parmi les plus hautes du monde (325 m), doivent leur couleur rouge à l'oxydation du fer.",hints:[
    ...
    {bc:"#052e16",tc:"#86efac",l:"FACILE",t:"Namibie — désert côtier aux dunes orangées les plus hautes du monde, rencontre mer-sable"},
  ...
  {name:"Parc national Kruger — Afrique du Sud",lat:-23.9884,lng:31.5547,desc:"Le parc Kruger est le plus grand parc national d'Afrique du Sud avec 20 000 km². Il abrite les «Big Five» (lion, éléphant, buffle, léopard, rhinocéros) en densités parmi les plus élevées d'Afrique. Sa clôture électrifiée de 800 km fut construite dans les années 1970 — le plus long périmètre de clôture d'une réserve naturelle au monde.",hints:[
    ...
    {bc:"#052e16",tc:"#86efac",l:"FACILE",t:"Limpopo, Afrique du Sud — plus grand parc d'Afrique australe, Big Five garantiés"},
  ...
  {name:"Karnak — Louxor, Égypte",lat:25.7188,lng:32.6573,desc:"La salle hypostyle de Karnak, avec ses 134 colonnes de 23 mètres de haut, est si grande qu'on pourrait y faire tenir la cathédrale Notre-Dame de Paris tout entière. L'élever prit 200 ans — soit le travail de 30 générations d'artisans.",hints:[
    ...
    {bc:"#052e16",tc:"#86efac",l:"FACILE",t:"Louxor, Égypte — plus grand complexe religieux du monde antique, allée des sphinx"},
  ...
  {name:"Chute Angel — Venezuela",lat:5.97,lng:-62.535,desc:"La chute Angel est si haute que son eau se vaporise en grande partie avant d'atteindre le sol en saison sèche. Après une chute de 979 mètres, l'eau arrive sous forme de bruine ou de ruisseau, selon les conditions météo.",hints:[
    ...
    {bc:"#052e16",tc:"#86efac",l:"FACILE",t:"Venezuela — chute la plus haute du monde (979m), découverte par l'aviateur Jimmy Angel en 1937"},
  ...
  {name:"Canal de Panama",lat:9.0798,lng:-79.6816,desc:"Le canal de Panama raccourcit de 15 000 km le trajet entre les océans Atlantique et Pacifique. Sa construction coûta la vie à 25 000 ouvriers entre 1881 et 1914, principalement à cause de la malaria et de la fièvre jaune.",hints:[
    ...
    {bc:"#052e16",tc:"#86efac",l:"FACILE",t:"Panama — canal reliant Atlantique et Pacifique, écluses de 26m de dénivelé, 14 000 navires/an"},
  ...
  {name:"Île de Pâques — Chili",lat:-27.1127,lng:-109.3497,desc:"Juste sous la surface de la mer entourant l'île de Pâques se trouvent des milliers de moaï submergés — les archéologues n'ont fouillé qu'une infime partie des fonds marins. Les têtes visibles sont en réalité des statues entières dont le corps est enfoui.",hints:[
    ...
    {bc:"#052e16",tc:"#86efac",l:"FACILE",t:"Île chiliienne isolée — 887 statues moai en pierre volcanique, écrites nulle part ailleurs"},
  ...
  {name:"Cathédrale de Brasilia — Brésil",lat:-15.7988,lng:-47.8758,desc:"La cathédrale de Brasilia, conçue par Oscar Niemeyer et inaugurée en 1970, est une sculpture hyperboloïde de 16 colonnes d'acier incurvées pesant 90 tonnes chacune. Son entrée se fait par un tunnel souterrain sombre pour que les fidèles jaillissent dans la lumière blanche de la nef vitrée — une métaphore de la résurrection.",hints:[
    ...
    {bc:"#052e16",tc:"#86efac",l:"FACILE",t:"Brasilia, Brésil — catédrale hyperboïoïde de 70m, 16 colonnes courbes, Oscar Niemeyer 1970"},
  ...
  {name:"Galápagos — Équateur",lat:-0.9538,lng:-90.9656,desc:"L'archipel des Galápagos est le laboratoire de l'évolution de Charles Darwin, qui y séjourna en 1835. L'isolement de ses îles créa des espèces uniques au monde : iguanes marins, pinsons de Darwin aux becs adaptés à chaque île, tortues géantes de 200 kg. 97% de l'archipel est parc national intangible.",hints:[
    ...
    {bc:"#052e16",tc:"#86efac",l:"FACILE",t:"Galapagos, Équateur — archipel volcanique, iguanes marins et tortues géantes, labo de Darwin"},
  ...
  {name:"Times Square — New York, USA",lat:40.758,lng:-73.9855,desc:"Times Square doit son nom au New York Times qui y installa son siège en 1904 et y fit tomber pour la première fois la «ball drop» du Nouvel An. Avec 50 millions de visiteurs par an, c'est le lieu le plus cher pour la publicité au monde — un panneau peut coûter 50 000 dollars par jour.",hints:[
    ...
    {bc:"#052e16",tc:"#86efac",l:"FACILE",t:"Manhattan, New York — croisement de Broadway et de la 7ème Avenue, boule du Nouvel An"},
    {bc:"#0c1a3e",tc:"#93c5fd",l:"TRÈS FACILE",t:"États-Unis"}
  ]},
  {name:"Cap Canaveral — Floride, USA",lat:28.3922,lng:-80.6077,desc:"Cap Canaveral est le berceau de l'ère spatiale américaine depuis 1950. Son pas de tir 39A vit partir Apollo 11 vers la Lune en 1969. Racheté par SpaceX en 2014, ce même site historique accueille aujourd'hui les fusées Falcon 9 et Starship — une continuité symbolique entre deux époques de l'exploration spatiale.",hints:[
    ...
    {bc:"#052e16",tc:"#86efac",l:"FACILE",t:"Floride, États-Unis — centre spatial NASA, rampe 39A, départs d'Apollo 11 et des navettes"},
    {bc:"#0c1a3e",tc:"#93c5fd",l:"TRÈS FACILE",t:"États-Unis"}
  ]},
  ...
  {name:"Teotihuacan — Mexique",lat:19.6925,lng:-98.8438,desc:"Teotihuacan était l'une des plus grandes villes du monde en l'an 500 ap. J.-C., avec 200 000 habitants. Personne ne sait quelle civilisation la construisit — les Aztèques, qui la découvrirent des siècles plus tard, la nommèrent «le lieu où les hommes deviennent des dieux».",hints:[
    ...
    {bc:"#052e16",tc:"#86efac",l:"FACILE",t:"Mexique — cité précolômbienne la plus grande, pyramide du Soleil de 65m, Voie des Morts"},
  ...
  {name:"Great Barrier Reef — Queensland, Australie",lat:-18.2861,lng:147.6992,desc:"Le Grand Récif corallien est le plus grand organisme vivant de la planète — visible depuis l'espace. Sa surface est inférieure de moitié à celle de 1960 à cause du réchauffement climatique et de l'acidification des océans. Des chercheurs travaillent à congeler des fragments de corail pour permettre une future restauration.",hints:[
    ...
    {bc:"#052e16",tc:"#86efac",l:"FACILE",t:"Queensland, Australie — plus grand récif corallien (2300 km), visible depuis l'espace"},
  ...
  {name:"Fiordland — Milford Sound, Nouvelle-Zélande",lat:-44.6413,lng:167.9263,desc:"Le parc national de Fiordland reçoit jusqu'à 9 mètres de pluie par an — l'un des endroits les plus pluvieux du monde. Cette eau crée des centaines de cascades éphémères qui cascadent des parois à pic pendant et après chaque pluie.",hints:[
    ...
    {bc:"#052e16",tc:"#86efac",l:"FACILE",t:"Île du Sud, Nouvelle-Zélande — fjord aux eaux noires entre des falaises de 1200m"},
    {bc:"#0c1a3e",tc:"#93c5fd",l:"TRÈS FACILE",t:"Nouvelle-Zélande"}
  ]},
  {name:"Bora Bora — Polynésie française",lat:-16.5004,lng:-151.7415,desc:"Le lagon de Bora Bora est un ancien cratère volcanique envahi par la mer. La barrière de corail qui l'entoure est si peu profonde qu'on peut la traverser à pied à marée basse dans certains endroits, créant une expérience unique de marche sur l'eau.",hints:[
    ...
    {bc:"#052e16",tc:"#86efac",l:"FACILE",t:"Polynésie française — atoll de lagon turquoise, surhumé par le mont Otemanu (727m)"},
  ...
  {name:"Palmyre — Syrie",lat:34.5503,lng:38.2688,desc:"La reine de Palmyre, Zénobie, défia Rome en 270 ap. J.-C. en conquérant l'Égypte et l'Anatolie avec son armée. Capturée par l'empereur Aurélien, elle fut exhibée à Rome enchaînée d'or massif — un hommage paradoxal à sa grandeur.",hints:[
    ...
    {bc:"#052e16",tc:"#86efac",l:"FACILE",t:"Désert syrien — cité caravanière antique surnommée la Porte du Désert, temples roméns"},
  ...
  {name:"Persépolis — Iran",lat:29.9348,lng:52.8913,desc:"Persépolis était le symbole de la richesse et du pouvoir achéménide. Ses bas-reliefs représentent 23 nations soumises portant des tributes — une carte vivante de l'empire le plus vaste de l'Antiquité, qui s'étendait de la Grèce à l'Inde.",hints:[
    ...
    {bc:"#052e16",tc:"#86efac",l:"FACILE",t:"Iran — palais acéménide de Darius le Grand, 2500 ans, bas-reliefs de l'escalier d'Apadana"},
    {bc:"#0c1a3e",tc:"#93c5fd",l:"TRÈS FACILE",t:"Iran"}
  ]},
  {name:"Coupole du Rocher — Jérusalem",lat:31.7781,lng:35.2354,desc:"Le Dôme du Rocher, sanctuaire islamique construit en 691, recouvre le rocher d'où le prophète Mahomet serait monté au ciel lors de son voyage nocturne. Ses mosaïques et carreaux de faïence furent entièrement restaurés par la Jordanie en 1959 et 2016. Son dôme doré est recouvert de 5 000 plaques d'or.",hints:[
    ...
    {bc:"#052e16",tc:"#86efac",l:"FACILE",t:"Jérusalem — coupole dorée sur l'esplanade des mosquées, rocher de l'Ascension du Prophète"},
    {bc:"#0c1a3e",tc:"#93c5fd",l:"TRÈS FACILE",t:"Jérusalem"}
  ]},
  {name:"Cappadoce — Turquie",lat:38.6431,lng:34.8289,desc:"Les cheminées de fées de Cappadoce furent habitées pendant des millénaires. Les premières communautés chrétiennes y creusèrent des villes souterraines entières pour échapper aux persécutions romaines — certaines pouvaient abriter 20 000 personnes sur 8 niveaux.",hints:[
    ...
    {bc:"#052e16",tc:"#86efac",l:"FACILE",t:"Cappadoce, Turquie — cheminées de fées et maisons troglodytes dans le tuf volcanique"},
    {bc:"#0c1a3e",tc:"#93c5fd",l:"TRÈS FACILE",t:"Turquie"}
  ]},
  {name:"Château de Kronborg — Elseneur, Danemark",lat:56.039,lng:12.6213,desc:"Le château de Kronborg inspira Shakespeare pour son Hamlet, bien que le dramaturge n'ait probablement jamais visité le Danemark. La légende dit que le héros Viking Holger Danske dort dans ses caves et se réveillera si le Danemark est en danger.",hints:[
    ...
    {bc:"#052e16",tc:"#86efac",l:"FACILE",t:"Elseneur, Danemark — château rendu célèbre par Hamlet de Shakespeare, détroit de l'Øresund"},
  ...
  {name:"Opéra de Copenhague — Danemark",lat:55.6786,lng:12.5997,desc:"L'Opéra de Copenhague, inauguré en 2005, fut entièrement financé par le magnat de la marine Mærsk Mc-Kinney Møller pour 500 millions d'euros. Ses 14 mètres de porte-à-faux et son toit doré de 32 mètres surplombant le port en font l'un des opéras les plus modernes et chers jamais construits.",hints:[
    ...
    {bc:"#052e16",tc:"#86efac",l:"FACILE",t:"Copenhague, Danemark — opéra moderne sur l'île de Holmen, toit de zinc, 1 400 places"},
    {bc:"#0c1a3e",tc:"#93c5fd",l:"TRÈS FACILE",t:"Danemark"}
  ]},
  {name:"Vieux-Port de Stockholm — Suède",lat:59.3245,lng:18.0726,desc:"Gamla Stan est construite sur une île artificielle créée au XIIIe siècle. Ses ruelles les plus étroites ne mesurent que 90 cm de large — soit exactement la largeur des traîneaux à chevaux de l'époque médiévale.",hints:[
    ...
    {bc:"#052e16",tc:"#86efac",l:"FACILE",t:"Stockholm, Suède — vieux port (Gamla Stan) sur une île, maisons colorées du XVIIe siècle"},
  ...
  {name:"Palais Royal de Stockholm — Suède",lat:59.3268,lng:18.0717,desc:"Le palais royal de Stockholm, achevé en 1754, est l'une des plus grandes résidences royales encore en service avec ses 1 430 pièces. Contrairement à Buckingham, il est ouvert au public l'été entier. La garde royale défile chaque jour à midi dans une cérémonie très populaire.",hints:[
    ...
    {bc:"#052e16",tc:"#86efac",l:"FACILE",t:"Stockholm, Suède — palais royal de 608 pièces, relève de la garde quotidienne"},
    {bc:"#0c1a3e",tc:"#93c5fd",l:"TRÈS FACILE",t:"Suède"}
  ]},
  {name:"Bibliothèque de l'Université d'Helsinki — Finlande",lat:60.1699,lng:24.9384,desc:"La bibliothèque nationale de Finlande, bâtie en 1840 par Carl Ludwig Engel, est le chef-d'œuvre néoclassique d'Helsinki. Son architecture sobre et majestueuse fut conçue pour rivaliser avec les grandes bibliothèques européennes. Elle abrite un exemplaire de chaque livre publié en Finlande depuis 1707 — un dépôt légal exceptionnel.",hints:[
    ...
    {bc:"#052e16",tc:"#86efac",l:"FACILE",t:"Helsinki, Finlande — bibliothèque universitaire néoclassique, place du Sénat, Carl Ludwig Engel"},
    {bc:"#0c1a3e",tc:"#93c5fd",l:"TRÈS FACILE",t:"Finlande"}
  ]},
  {name:"Vieux-Tallinn — Estonie",lat:59.437,lng:24.7453,desc:"Tallinn possède l'une des vieilles villes médiévales les mieux préservées d'Europe du Nord. Sa pharmacie, fondée en 1422, est l'une des plus anciennes pharmacies encore en activité au monde.",hints:[
  ...
  {name:"Château de Trakai — Lituanie",lat:54.6479,lng:24.9347,desc:"Le château de Trakai, bâti sur une île du lac Galvė au XIVe siècle, est le château insulaire le plus oriental d'Europe. Il fut la résidence du Grand-Duc Vytautas qui étendit la Lituanie jusqu'à la mer Noire, créant le plus grand État d'Europe médiévale.",hints:[
    ...
    {bc:"#052e16",tc:"#86efac",l:"FACILE",t:"Lituanie — château gothique rouge sur une île du lac Galvė, ancienne capitale du Grand-Duché"},
  ...
  {name:"Vieille ville de Dubrovnik — Croatie",lat:42.6507,lng:18.0944,desc:"Les remparts de Dubrovnik furent construits à partir du XIIIe siècle et n'ont jamais été percés par un ennemi. La cité-état de Raguse fut l'une des premières républiques marchandes à abolir l'esclavage, en 1418, trois siècles avant les nations modernes.",hints:[
    ...
    {bc:"#052e16",tc:"#86efac",l:"FACILE",t:"Croatie — vieille ville ceintée de 2 km de remparts médiévaux, joyau de la mer Adriatique"},
  ...
  {name:"Pont de Mostar — Bosnie-Herzégovine",lat:43.337,lng:17.8156,desc:"Le Stari Most de Mostar, pont ottoman construit en 1566, fut délibérément détruit par des obus croates en novembre 1993. Sa reconstruction, achevée en 2004, utilisa les mêmes techniques du XVIe siècle et la même pierre locale — le tenelija. La reconstruction de ce pont devint un symbole de réconciliation.",hints:[
    ...
    {bc:"#052e16",tc:"#86efac",l:"FACILE",t:"Bosnie — pont ottoman du XVIe siècle reconstruit en 2004, plongeurs traditionnels"},
  ...
  {name:"Monastère de Meteora — Grèce",lat:39.7217,lng:21.6306,desc:"Les monastères de Météora sont construits au sommet de pitons rocheux de grès atteignant 600 mètres. Fondés au XIVe siècle par des moines fuyant les invasions ottomanes, ils étaient accessibles uniquement par des échelles amovibles ou des paniers hissés par des treuils — pour décourager les intrus.",hints:[
    ...
    {bc:"#052e16",tc:"#86efac",l:"FACILE",t:"Grèce — monastères byzantins perchés au sommet de pitons rocheux, classés UNESCO"},
    {bc:"#0c1a3e",tc:"#93c5fd",l:"TRÈS FACILE",t:"Grèce"}
  ]},
  {name:"Place Wenceslas — Prague, Rép. Tchèque",lat:50.0813,lng:14.4281,desc:"La place Venceslas de Prague n'est pas une place mais un boulevard de 750 mètres. C'est le centre politique de la Bohême depuis le Moyen Âge. Jan Palach s'y immola par le feu en 1969 pour protester contre l'invasion soviétique. En 1989, des centaines de milliers de personnes y manifestèrent lors de la Révolution de velours.",hints:[
    ...
    {bc:"#052e16",tc:"#86efac",l:"FACILE",t:"Prague, Tchéquie — place Venceslas, boulevard de 750m, coeur de la Nouvelle Ville"},
  ...
  {name:"Auschwitz-Birkenau — Pologne",lat:50.0341,lng:19.1783,desc:"Auschwitz-Birkenau fut libéré le 27 janvier 1945 par l'armée soviétique. Ce jour est devenu la Journée internationale de la mémoire des victimes de l'Holocauste. Le site, classé UNESCO, reçoit plus de 2 millions de visiteurs par an.",hints:[
    ...
    {bc:"#052e16",tc:"#86efac",l:"FACILE",t:"Sud de la Pologne — plus grand camp d'extermination nazi, 1,1 million de victimes"},
    {bc:"#0c1a3e",tc:"#93c5fd",l:"TRÈS FACILE",t:"Pologne"}
  ]},
  {name:"Château de Bran — Roumanie",lat:45.5152,lng:25.367,desc:"Le château de Bran fut associé à Dracula par des touristes et éditeurs anglais qui cherchaient un décor réel pour le roman de Bram Stoker (1897). Stoker ne visita jamais la Roumanie et s'inspira uniquement de livres. Vlad l'Empaleur, le vrai prince valaque cruel, n'y séjourna probablement que très brièvement.",hints:[
    ...
    {bc:"#052e16",tc:"#86efac",l:"FACILE",t:"Roumanie — château médiéval en Transylvanie associé à la légende de Dracula"},
  ...
  {name:"Lavra de Kiev — Ukraine",lat:50.4347,lng:30.5578,desc:"La Laure de Kiev-Petchersk, fondée en 1051, est le plus ancien monastère de la Russie kiévienne. Ses catacombes abritent les corps momifiés naturellement de moines médiévaux — une attraction macabre vieille de neuf siècles. Elle fut inscrite au patrimoine mondial de l'UNESCO en 1990.",hints:[
    ...
    {bc:"#052e16",tc:"#86efac",l:"FACILE",t:"Kiev, Ukraine — laure orthodoxe du XIe siècle, clocher doré visible de toute la ville"},
  ...
  {name:"Cliffs of Moher — Irlande",lat:52.9715,lng:-9.4309,desc:"Les falaises de Moher servirent de décor dans Harry Potter et les Reliques de la Mort. Elles sont habitées par 30 000 oiseaux de mer de 20 espèces différentes, dont des macareux qui creusent leurs terriers dans le sommet herbeux des falaises.",hints:[
    ...
    {bc:"#052e16",tc:"#86efac",l:"FACILE",t:"Irlande — falaises de craie de 214m de haut, 8 km de long, battues par l'Atlantique"},
  ...
  {name:"Château de Blarney — Irlande",lat:51.9293,lng:-8.5718,desc:"La Pierre d'Éloquence du château de Blarney, encastrée sous le parapet à 25 mètres de hauteur, s'embrasse en se penchant en arrière. Selon la légende, qui l'embrasse reçoit le don de flattery — l'art de parler avec charme et conviction. Winston Churchill et Mick Jagger l'auraient embrassée.",hints:[
    ...
    {bc:"#052e16",tc:"#86efac",l:"FACILE",t:"Cork, Irlande — château médiéval, Pierre de Blarney à embrasser pour avoir l'éloquence"},
    {bc:"#0c1a3e",tc:"#93c5fd",l:"TRÈS FACILE",t:"Irlande"}
  ]},
  ...
  {name:"Château de Chillon — Suisse",lat:46.4142,lng:6.9274,desc:"Lord Byron grava son nom sur une colonne de la prison du château de Chillon lors de sa visite en 1816. Il y écrivit ensuite «Le Prisonnier de Chillon», poème inspiré de François Bonivard, emprisonné 4 ans dans les caves pour s'être opposé au duc de Savoie.",hints:[
    ...
    {bc:"#052e16",tc:"#86efac",l:"FACILE",t:"Vaud, Suisse — château médiéval sur un rocher dans le lac Léman, immortalisé par Byron"},
  ...
  {name:"Jet d'eau — Genève, Suisse",lat:46.2044,lng:6.1557,desc:"Le jet d'eau de Genève jaillit à 500 litres par seconde et monte à 140 mètres de hauteur. Il fut créé en 1891 pour réguler la pression hydraulique du réseau d'eau de la ville. Par vent fort, il peut doucher des passants à plusieurs centaines de mètres — les Genevois l'appellent affectueusement «la grande douche».",hints:[
    ...
    {bc:"#052e16",tc:"#86efac",l:"FACILE",t:"Genève, Suisse — jet d'eau de 140m à 500 l/s, symbole de la ville depuis 1891"},
    {bc:"#0c1a3e",tc:"#93c5fd",l:"TRÈS FACILE",t:"Suisse"}
  ]},
  {name:"Lac Baïkal — Sibérie, Russie",lat:53.5587,lng:108.165,desc:"Le lac Baïkal est si profond qu'on pourrait y empiler 6 tours Eiffel sans les voir dépasser. Sa rive orientale abrite des phoques d'eau douce — les seuls au monde — dont l'ancêtre aurait migré depuis l'Arctique il y a 20 millions d'années.",hints:[
    ...
    {bc:"#052e16",tc:"#86efac",l:"FACILE",t:"Sibérie, Russie — plus grand lac du monde en volume, 20% de l'eau douce de la planète"},
  ...
  {name:"Registan — Samarcande, Ouzbékistan",lat:39.6558,lng:66.9758,desc:"La place du Registan de Samarcande est ornée de carreaux de céramique vieux de 600 ans dont les couleurs sont aussi vives qu'au premier jour. Le secret des artisans timourides pour produire ce bleu lapis-lazuli immuable n'a jamais été totalement élucidé.",hints:[
    ...
    {bc:"#052e16",tc:"#86efac",l:"FACILE",t:"Samarcande, Ouzbékistan — grande place entourée de 3 medersas aux façades de faïence bleue"},
    {bc:"#0c1a3e",tc:"#93c5fd",l:"TRÈS FACILE",t:"Ouzbékistan"}
  ]},
  {name:"Palais de Topkapi — Istanbul, Turquie",lat:41.0115,lng:28.9833,desc:"Le palais de Topkapi fut le centre de l'Empire ottoman pendant 400 ans. Son Harem abritait jusqu'à 600 femmes et eunuques. Le palais conserve les reliques les plus sacrées de l'Islam : le manteau et l'épée du prophète Mahomet, ainsi qu'une dent et un cheveu lui appartenant selon la tradition.",hints:[
    {bc:"#3b0f0f",tc:"#fca5a5",l:"EXPERT",t:"Topkapı Sarayı, résidence des sultans ottomans de 1465 à 1856, abritant le manteau du prophète et 86 carats du Diamant du Spoonmak"},
    ...
    {bc:"#052e16",tc:"#86efac",l:"FACILE",t:"Istanbul, Turquie — palais ottoman des sultans, 400 ans de siège du pouvoir, bord du Bosphore"},
    {bc:"#0c1a3e",tc:"#93c5fd",l:"TRÈS FACILE",t:"Turquie"}
  ]},
  {name:"Pamukkale — Turquie",lat:37.92,lng:29.12,desc:"Pamukkale — «château de coton» en turc — est un site naturel unique : des sources thermales à 35°C chargées de carbonate de calcium ont créé des terrasses et cascades de travertin blanc sur 2 700 mètres. La cité antique d'Hiérapolis construite au-dessus comptait 100 000 habitants à son apogée romaine.",hints:[
    ...
    {bc:"#052e16",tc:"#86efac",l:"FACILE",t:"Turquie — terrasses de travertin blanc à l'eau turquoise, piscine thermale anté-romaine"},
    {bc:"#0c1a3e",tc:"#93c5fd",l:"TRÈS FACILE",t:"Turquie"}
  ]},
  {name:"Bagan — Myanmar",lat:21.1717,lng:94.8585,desc:"Les temples de Bagan sont peints de fresques représentant la vie du Bouddha. Après le tremblement de terre de 1975, des restaurations controversées utilisant du béton et des briques modernes furent critiquées par les archéologues — Bagan ne peut pas obtenir le statut UNESCO à cause de ces restaurations.",hints:[
    ...
    {bc:"#052e16",tc:"#86efac",l:"FACILE",t:"Myanmar — plus de 2 000 temples et stupa bouddhistes sur une plaine, VIIIe-XIIIe siècle"},
  ...
  {name:"Ha Long Bay — Vietnam",lat:20.9101,lng:107.1839,desc:"La baie d'Ha Long compte 1 969 îlots calcaires formés il y a 500 millions d'années. Selon la légende vietnamienne, un dragon descendit du ciel en battant de la queue, ses coups créant les vallées et les baies. La baie abriterait aussi des grottes marines habitées par des villages flottants de pêcheurs.",hints:[
    {bc:"#3b0f0f",tc:"#fca5a5",l:"EXPERT",t:"2 000 îlots et pitons calcaires karstiques sur 1 553 km², grotte de Hang ĝầu Gỗ, province de Quảng Ninh"},
    ...
    {bc:"#052e16",tc:"#86efac",l:"FACILE",t:"Vietnam — baie aux 2 000 îlots karstiques émergeant de l'eau émeraude, UNESCO"},
  ...
  {name:"Lac Tonlé Sap — Cambodge",lat:12.8679,lng:104.043,desc:"Le Tonlé Sap est le seul lac au monde dont le fleuve change de sens deux fois par an. En saison des pluies, le Mékong refoule ses eaux dans le lac qui quintuple de taille. En saison sèche, le flux s'inverse et le lac se vide progressivement.",hints:[
    ...
    {bc:"#052e16",tc:"#86efac",l:"FACILE",t:"Cambodge — plus grand lac d'eau douce d'Asie du Sud-Est, se multiplie par 5 en saison des pluies"},
    {bc:"#0c1a3e",tc:"#93c5fd",l:"TRÈS FACILE",t:"Cambodge"}
  ]},
  {name:"Gunung Bromo — Java, Indonésie",lat:-7.9425,lng:112.953,desc:"Le mont Bromo est un volcan actif dans une caldeira géante où vivent encore 30 000 personnes du peuple Tengger. Chaque année lors du festival Yadnya Kasada, ils jettent des offrandes — fleurs, riz, poules, chèvres — dans le cratère fumant pour remercier les dieux.",hints:[
    ...
    {bc:"#052e16",tc:"#86efac",l:"FACILE",t:"Java, Indonésie — caldera volcanique avec mer de sable, cratère fuméeux au lever du soleil"},
    {bc:"#0c1a3e",tc:"#93c5fd",l:"TRÈS FACILE",t:"Indonésie"}
  ]},
  {name:"Mrauk U — Myanmar",lat:20.5947,lng:93.2019,desc:"Mrauk U fut la capitale du royaume d'Arakan du XVe au XVIIIe siècle, une des villes les plus riches d'Asie du Sud-Est. Ses 700 temples en brique, enfouis dans la jungle, sont comparés à Bagan mais trois fois moins connus. Le site reste accessible uniquement par bateau sur la rivière Kaladan — son isolement le préserve du tourisme de masse.",hints:[
    ...
    {bc:"#052e16",tc:"#86efac",l:"FACILE",t:"Myanmar — ancienne capitale du royaume Arakan, temples en briques rouges dans la jungle"},
  ...
  {name:"Mosquée de Dôme des Umayyades — Damas, Syrie",lat:33.5114,lng:36.3069,desc:"La Grande Mosquée des Omeyyades de Damas est l'une des plus anciennes mosquées du monde (715 ap. J.-C.). Elle fut construite sur une église byzantine, elle-même bâtie sur un temple romain à Jupiter. Selon la tradition, la tête de Jean-Baptiste y est conservée dans un sanctuaire.",hints:[
    ...
    {bc:"#052e16",tc:"#86efac",l:"FACILE",t:"Damas, Syrie — plus ancienne grande mosqueée, mosaïques de la Ghouta, VIIIe siècle"},
    {bc:"#0c1a3e",tc:"#93c5fd",l:"TRÈS FACILE",t:"Syrie"}
  ]},
  {name:"Massif de l'Altaï — Mongolie",lat:48.9,lng:89.5,desc:"Le massif de l'Altaï mongol est la région natale de Gengis Khan et le berceau de la civilisation nomade des steppes. Ses montagnes abritent les aigles dorées dressées par les Kazakhs mongols pour la chasse — une tradition de 4 000 ans perpétuée par les derniers «berkutchi». Chaque automne, un festival des aigles y rassemble ces chasseurs.",hints:[
    {bc:"#3b0f0f",tc:"#fca5a5",l:"EXPERT",t:"Khüiten Peak (4 374 m), point culminant de Mongolie, massif glaciaire aux pétroglyphes vieux de 12 000 ans, province de Bayan-Ölgi"},
    ...
    {bc:"#052e16",tc:"#86efac",l:"FACILE",t:"Mongolie — massif de l'Altaï aux glaciers, nomades Kazakh aigliers, steppes à perte de vue"},
  ...
  {name:"Tombouctu — Mali",lat:16.7735,lng:3.0074,desc:"Tombouctou, surnommée «la ville aux 333 saints», fut au XVe siècle la capitale intellectuelle et spirituelle de l'Afrique avec 25 000 étudiants et une université réputée dans tout le monde islamique. Ses 700 000 manuscrits médiévaux préservés dans des bibliothèques privées représentent une archive unique de la pensée africaine précoloniale.",hints:[
    ...
    {bc:"#052e16",tc:"#86efac",l:"FACILE",t:"Mali — ancienne ville caravanière du Sahara, mosquées en terre crue, surnommée perle du désert"},
    {bc:"#0c1a3e",tc:"#93c5fd",l:"TRÈS FACILE",t:"Mali"}
  ]},
  {name:"Désert du Sahara — Algérie (Tassili)",lat:25.4167,lng:8.4167,desc:"Le Tassili n'Ajjer en Algérie est un vaste plateau rocheux abritant 15 000 peintures et gravures rupestres réalisées entre -10 000 et -2 000 av. J.-C. Ces œuvres représentent des éléphants, hippopotames et crocodiles — preuve que le Sahara était autrefois une savane verdoyante. L'UNESCO le classe double patrimoine naturel et culturel.",hints:[
    ...
    {bc:"#052e16",tc:"#86efac",l:"FACILE",t:"Algérie — peintures rupestres du Tassili n'Ajjer, 15 000 gravures, 6000 ans d'histoire"},
  ...
  {name:"Médina de Fès — Maroc",lat:34.0633,lng:-5.0039,desc:"La médina de Fès el-Bali, fondée en 808, est la plus grande zone urbaine piétonne au monde — aucune voiture n'y passe. Ses 9 400 ruelles labyrinthiques peuvent faire tourner en rond même les habitants. Les tanneries Chouara, actives depuis le XIe siècle, produisent du cuir selon des méthodes inchangées — cuves de pigments naturels creusées dans la roche.",hints:[
    ...
    {bc:"#052e16",tc:"#86efac",l:"FACILE",t:"Maroc — médina de Fès, tannéeries colorées, l'un des plus grands marchés traditionnels d'Afrique"},
    {bc:"#0c1a3e",tc:"#93c5fd",l:"TRÈS FACILE",t:"Maroc"}
  ]},
  {name:"Château de Gorée — Sénégal (Fort d'Estrées)",lat:14.6685,lng:-17.3991,desc:"Le Fort d'Estrées sur l'île de Gorée fut construit par les Hollandais en 1659 puis capturé par la France. L'île de Gorée fut pendant trois siècles la principale plaque tournante de la traite négrière vers les Amériques. La Maison des Esclaves, avec sa «porte du voyage sans retour» ouverte sur l'Atlantique, est devenue un mémorial mondial.",hints:[
    ...
    {bc:"#052e16",tc:"#86efac",l:"FACILE",t:"Sénégal — île négrière de Gorée, Maison des Esclaves, site mémorial UNESCO"},
    {bc:"#0c1a3e",tc:"#93c5fd",l:"TRÈS FACILE",t:"Sénégal"}
  ]},
  {name:"Serengeti — Tanzanie",lat:-2.3333,lng:34.8333,desc:"La Grande Migration du Serengeti est guidée uniquement par l'instinct collectif et la détection de l'herbe fraîche par les gnous. Aucun animal ne «dirige» le mouvement — c'est un phénomène d'intelligence collective qui déplace 1,5 million d'animaux sur 1 800 km.",hints:[
    ...
    {bc:"#052e16",tc:"#86efac",l:"FACILE",t:"Tanzanie — grande migration de 1,5 million de gnous et zèbres, relation prédateur-proie"},
  ...
  {name:"Masai Mara — Kenya",lat:-1.5,lng:35.15,desc:"La traversée de la rivière Mara par les gnous est l'un des spectacles naturels les plus dramatiques du monde. Des centaines d'animaux plongent dans des eaux infestées de crocodiles du Nil — certains crocodiles de la Mara pèsent plus de 700 kg et attendent les migrations depuis des décennies.",hints:[
    ...
    {bc:"#052e16",tc:"#86efac",l:"FACILE",t:"Kenya — réserve Masai Mara, grande migration, villages masai traditionnels"},
  ...
  {name:"Chutes de Kalandula — Angola",lat:-9.0667,lng:15.95,desc:"Les chutes de Kalandula en Angola sont les deuxièmes plus grandes d'Afrique par leur débit. Tombant de 105 mètres sur une largeur de 400 mètres, elles créent une brume permanente qui maintient une végétation tropicale luxuriante dans un rayon d'un kilomètre.",hints:[
    ...
    {bc:"#052e16",tc:"#86efac",l:"FACILE",t:"Angola — plus grande chute d'Afrique subsaharienne en volume (400m de large, 105m de haut)"},
  ...
  {name:"Grand Zimbabwe — Zimbabwe",lat:-20.2667,lng:30.9333,desc:"Le Grand Zimbabwe, dont le nom signifie «maison de pierre» en shona, est le plus grand complexe de ruines d'Afrique subsaharienne hors Égypte. Ses murs de 11 mètres de haut furent construits sans mortier avec une précision stupéfiante. Il donna son nom au pays lors de l'indépendance en 1980.",hints:[
    ...
    {bc:"#052e16",tc:"#86efac",l:"FACILE",t:"Zimbabwe — cité médiévale en pierre sèche, capitale du royaume Shona, IXe-XVe siècle"},
  ...
  {name:"Vallée des Rois — Louxor, Égypte",lat:25.7402,lng:32.6014,desc:"Toutânkhamon est le seul pharaon de la Vallée des Rois à avoir eu sa tombe retrouvée quasi intacte. Howard Carter l'ouvrit en 1922 après 10 ans de fouilles. La malédiction qui aurait frappé les fouilleurs est aujourd'hui attribuée à des moisissures ou des spores pathogènes conservées dans l'air confiné.",hints:[
    ...
    {bc:"#052e16",tc:"#86efac",l:"FACILE",t:"Louxor, Égypte — vallée des pharaons, 63 tombes royales, celle de Toutânkhamon découverte 1922"},
    {bc:"#0c1a3e",tc:"#93c5fd",l:"TRÈS FACILE",t:"Égypte"}
  ]},
  ...
  {name:"Quebéc — Canada",lat:46.8139,lng:-71.208,desc:"La ville de Québec est la seule ville fortifiée au nord du Mexique en Amérique du Nord. Ses remparts du XVIIe siècle, longs de 4,6 km, sont encore parfaitement conservés. Le château Frontenac, hôtel le plus photographié au monde selon Guinness, domine le cap Diamant depuis 1893.",hints:[
    ...
    {bc:"#052e16",tc:"#86efac",l:"FACILE",t:"Canada — seule ville fortifiée d'Amérique du Nord, château Frontenac et Vieille Ville"},
    {bc:"#0c1a3e",tc:"#93c5fd",l:"TRÈS FACILE",t:"Canada"}
  ]},
  ...
  {name:"Monument Valley — Arizona/Utah, USA",lat:36.9991,lng:-110.0985,desc:"Monument Valley est la propriété privée de la Nation Navajo qui en contrôle strictement le tourisme. Les formations rocheuses rouges, appelées «buttes», sont si emblématiques de l'Ouest américain qu'elles ont servi de décor à des dizaines de westerns de John Ford.",hints:[
    ...
    {bc:"#052e16",tc:"#86efac",l:"FACILE",t:"Arizona-Utah, USA — buttes de grès rouge et mesas, territoire Navajo, horizon infini"},
    {bc:"#0c1a3e",tc:"#93c5fd",l:"TRÈS FACILE",t:"États-Unis"}
  ]},
  {name:"Antelope Canyon — Arizona, USA",lat:36.8619,lng:-111.3743,desc:"Antelope Canyon est un «slot canyon» créé par des millénaires d'érosion par les crues soudaines. Des rais de lumière pénètrent par l'ouverture en été et créent des «colonnes de lumière» dans la poussière — parmi les photographies les plus reproduites au monde.",hints:[
    ...
    {bc:"#052e16",tc:"#86efac",l:"FACILE",t:"Arizona, USA — canyon sinueux taillé dans le grès, rayons de lumière en faisceaux"},
    {bc:"#0c1a3e",tc:"#93c5fd",l:"TRÈS FACILE",t:"États-Unis"}
  ]},
  ...
  {name:"Ligne Nazcа — Pérou",lat:-14.739,lng:-75.13,desc:"Les lignes de Nazca furent créées en ôtant les pierres sombres du désert pour révéler le sable clair en dessous. Elles couvrent 450 km² et représentent 70 animaux et plantes, 300 figures géométriques. Maria Reiche consacra 50 ans de sa vie à les étudier, vivant seule dans le désert pour les protéger.",hints:[
    ...
    {bc:"#052e16",tc:"#86efac",l:"FACILE",t:"Pérou — 300 géoglyphes tracés dans le désert, visibles uniquement du ciel"},
  ...
  {name:"Carnaval de Rio — Sambodrome, Brésil",lat:-22.9122,lng:-43.1971,desc:"Le Carnaval de Rio est le plus grand du monde avec 2 millions de personnes par jour dans les rues. Le Sambódromo, conçu par Oscar Niemeyer en 1984, peut accueillir 90 000 spectateurs. Les écoles de samba travaillent toute l'année sur leurs chars et costumes — un budget annuel de plusieurs millions de dollars chacune.",hints:[
    ...
    {bc:"#052e16",tc:"#86efac",l:"FACILE",t:"Rio de Janeiro, Brésil — sambodrome du Marquis de Sapucaï, carnaval de 2 millions de personnes"},
    {bc:"#0c1a3e",tc:"#93c5fd",l:"TRÈS FACILE",t:"Brésil"}
  ]},
  {name:"Lac Titicaca — Bolivie/Pérou",lat:-15.8402,lng:-69.3329,desc:"Le lac Titicaca abrite les îles flottantes des Uros, construites entièrement en roseaux totora sur l'eau. Les habitants renouvellent constamment leur île en ajoutant des couches fraîches par-dessus les couches en décomposition.",hints:[
    ...
    {bc:"#052e16",tc:"#86efac",l:"FACILE",t:"Andes, Bolivie-Pérou — plus haut lac navigable du monde (3 812m), îles flottantes des Urus"},
  ...
  {name:"Salar d'Uyuni — Bolivie",lat:-20.1338,lng:-67.4891,desc:"Le salar d'Uyuni contient 70% des réserves mondiales de lithium, la matière première des batteries des voitures électriques. Le Belize entier se couvre d'un miroir parfait de quelques centimètres d'eau après les pluies.",hints:[
    ...
    {bc:"#052e16",tc:"#86efac",l:"FACILE",t:"Bolivie — plus grand désert de sel du monde (10 582 km²), miroir géant après la pluie"},
  ...
  {name:"Orinoco — Venezuela (Delta)",lat:8.6,lng:-61,desc:"Le delta de l'Orénoque, le troisième plus long fleuve d'Amérique du Sud, est habité par les Warao — «peuple des canoës» — depuis des millénaires. Ses 44 000 km² de forêts inondées abritent dauphins de rivière, loutres géantes et anacondas. De grandes gisements de pétrole ont été découverts sous son lit.",hints:[
    ...
    {bc:"#052e16",tc:"#86efac",l:"FACILE",t:"Venezuela — delta de l'Orinôco, 40 000 km² de mangroves et bras du fleuve"},
    {bc:"#0c1a3e",tc:"#93c5fd",l:"TRÈS FACILE",t:"Venezuela"}
  ]},
  {name:"Daintree Rainforest — Queensland, Australie",lat:-16.17,lng:145.418,desc:"La forêt de Daintree est plus ancienne de 10 fois que la forêt amazonienne. Ses espèces végétales primitives — fougères arborescentes, platanes primitifs, Idiospermum — n'ont pas changé depuis l'ère des dinosaures. C'est un musée vivant de l'évolution.",hints:[
    ...
    {bc:"#052e16",tc:"#86efac",l:"FACILE",t:"Queensland, Australie — forêt tropicale la plus ancienne du monde, 180 millions d'années"},
    {bc:"#0c1a3e",tc:"#93c5fd",l:"TRÈS FACILE",t:"Australie"}
  ]},
  {name:"Rotorua — Nouvelle-Zélande",lat:-38.1368,lng:176.2497,desc:"Rotorua sent constamment le soufre — les habitants plaisantent en disant que «ça pue, mais ça enrichit». Les sources géothermiques chauffent naturellement les maisons et alimentent une centrale électrique. La boue bouillonnante atteint parfois 200°C.",hints:[
    ...
    {bc:"#052e16",tc:"#86efac",l:"FACILE",t:"Nouvelle-Zélande — géisers, boue bouillonnante et lacs colorés, capitale géothermique"},
    {bc:"#0c1a3e",tc:"#93c5fd",l:"TRÈS FACILE",t:"Nouvelle-Zélande"}
  ]},
  {name:"Îles Marquises — Polynésie française",lat:-9,lng:-139.5,desc:"Les îles Marquises sont les îles habitées les plus isolées du monde — à 1 400 km de Tahiti et 4 000 km de la côte américaine la plus proche. Paul Gauguin y mourut en 1903 après y avoir peint ses tableaux les plus célèbres. Jacques Brel y repose également, dans le même cimetière que Gauguin à Hiva Oa.",hints:[
    ...
    {bc:"#052e16",tc:"#86efac",l:"FACILE",t:"Polynésie française — archipel des Marquises, falaises volcaniques, tikis de pierre"},
    {bc:"#0c1a3e",tc:"#93c5fd",l:"TRÈS FACILE",t:"Polynésie française (France)"}
  ]},
  {name:"Parc national de Fiordland — Nouvelle-Zélande",lat:-45.4142,lng:167.7192,desc:"Le parc national de Fiordland reçoit jusqu'à 9 mètres de pluie par an — l'un des endroits les plus pluvieux du monde. Cette eau crée des centaines de cascades éphémères qui cascadent des parois à pic pendant et après chaque pluie.",hints:[
    ...
    {bc:"#052e16",tc:"#86efac",l:"FACILE",t:"Nouvelle-Zélande — fjord de Milford Sound, cascades de 160m, dauphin de Hector"},
    {bc:"#0c1a3e",tc:"#93c5fd",l:"TRÈS FACILE",t:"Nouvelle-Zélande"}
  ]},
  {name:"Nauru — Micronésie",lat:-0.5228,lng:166.9315,desc:"Nauru fut, dans les années 1980, le pays à revenu par habitant le plus élevé du monde grâce à ses gisements de phosphate. Après l'épuisement des ressources, l'île est aujourd'hui l'un des pays les plus endettés et souffre d'une obésité endémique liée à un régime alimentaire ultra-transformé importé.",hints:[
    ...
    {bc:"#052e16",tc:"#86efac",l:"FACILE",t:"Micronésie — plus petit État indépendant du monde (21 km²), phôsphate et oiseau frigate"},
  ...
  {name:"Dôme de Florence — Italie",lat:43.7731,lng:11.256,desc:"Pascal fit monter du mercure au sommet du Puy de Dôme en 1648 pour prouver que la pression atmosphérique diminuait avec l'altitude — une expérience fondatrice de la physique moderne. Il ne fit pas l'ascension lui-même, mais demanda à son beau-frère.",hints:[
  ...
  {name:"Sagrada Família — Vue aérienne, Barcelone",lat:41.4036,lng:2.1745,desc:"Gaudí consacra les 43 dernières années de sa vie à cette cathédrale. Renversé par un tramway en 1926, il fut enterré dans sa propre église. La construction, financée uniquement par les entrées des visiteurs, devrait s'achever en 2026.",hints:[
    ...
    {bc:"#052e16",tc:"#86efac",l:"FACILE",t:"Quartier de l'Eixample, Barcelone, Espagne — basilique en construction depuis 1882"},
    {bc:"#0c1a3e",tc:"#93c5fd",l:"TRÈS FACILE",t:"Espagne"}
  ]},
  ...
  {name:"Gorges du Verdon — France",lat:43.721,lng:6.344,desc:"Le Verdon doit ses eaux d'un turquoise irréel aux particules de calcaire en suspension qui réfractent la lumière bleue. La gorge, jusqu'à 700 mètres de profondeur, ne fut explorée pour la première fois qu'en 1905 par le géographe Édouard-Alfred Martel.",hints:[
  ...
  {name:"Los Roques — Venezuela",lat:11.86,lng:-66.67,desc:"Los Roques est un archipel de 350 îles coralliennes dans la mer des Caraïbes, intégralement parc national depuis 1972. Ses lagons peu profonds d'un bleu irréel sont parmi les plus transparents des Caraïbes. Les plages de sable blanc sont inaccessibles en voiture — tout l'archipel se visite à pied ou en bateau.",hints:[
  ...
  {name:"Aoraki Mount Cook — Nouvelle-Zélande",lat:-43.595,lng:170.1418,desc:"Aoraki Mount Cook, à 3 724 mètres, est le plus haut sommet de Nouvelle-Zélande. Sir Edmund Hillary, premier homme à gravir l'Everest en 1953, s'y entraîna. Son parc national est classé au sein du «Dark Sky Reserve» — l'une des 20 plus belles zones d'observation astronomique au monde.",hints:[
  ...
  {name:"Osaka Castle — Osaka, Japon",lat:34.6873,lng:135.5261,desc:"Le château d'Osaka est entouré du plus grand marché de cerisiers en fleur du Kansai. Sa fondation fut réalisée avec des pierres géantes portant des inscriptions — les daimyos rivaux prouvaient leur loyauté en contribuant des blocs de pierre. La plus grande pierre, «Higo no Ishi», pèse 130 tonnes.",hints:[
    {bc:"#3b0f0f",tc:"#fca5a5",l:"EXPERT",t:"Ōsaka-jŝ, construit par Toyotomi Hideyoshi en 1583, tour de 5 étages, cerisiers du Nishinomaru Garden"},
    {bc:"#3d1a05",tc:"#fdba74",l:"DIFFICILE",t:"Chūŝ-ku, parc du château d'Osaka, rive de l'Okawa, Osaka"},
  ...
  {name:"Nara — Japon (Grand Bouddha)",lat:34.6884,lng:135.8395,desc:"Le Tŝdai-ji de Nara abrite le plus grand Bouddha en bronze du monde — 15 mètres et 500 tonnes. Une narine de l'une de ses colonnes de bois a exactement la taille du nez du Bouddha : quiconque passe à travers est assuré d'atteindre l'illumination. Des centaines de touristes tentent chaque jour de se glisser dans ce trou.",hints:[
    {bc:"#3b0f0f",tc:"#fca5a5",l:"EXPERT",t:"Tŝdai-ji, temple bouddhiste de 745, plus grand bâtiment en bois du monde, Daibutsu-den abritant le Bouddha de bronze de 15m"},
  ...
  {name:"Tsingy de Bemaraha — Madagascar",lat:-18.45,lng:44.75,desc:"Les forêts de Tsingy de Madagascar sont des forêts de lames calcaires si acérées qu'elles tranchent les semelles de chaussures. Leur nom malgache signifie «où on ne peut pas marcher pieds nus».",hints:[
  ...
  {name:"Erg Chebbi — Maroc",lat:31.15,lng:-3.95,desc:"L'Erg Chebbi, avec ses dunes atteignant 150 mètres près de Merzouga, est l'une des deux seules vraies mers de sable du Maroc. La dune la plus haute change de couleur selon la lumière : orangée le matin, rouge vif à midi, dorée au coucher du soleil. Des bivouacs nomades permettent de dormir sous les étoiles du Sahara.",hints:[
  ...
  {name:"Leptis Magna — Libye",lat:32.6386,lng:14.295,desc:"Leptis Magna est l'une des cités romaines les mieux conservées du monde — protégée pendant des siècles par les sables du Sahara. Lieu de naissance de l'empereur Septime Sévère, elle fut embellie de monuments colossaux à sa gloire. Son arc de triomphe à quatre faces est unique dans l'Empire romain.",hints:[
  ...
  {name:"Stone Town — Zanzibar, Tanzanie",lat:-6.1633,lng:39.19,desc:"Zanzibar est le lieu de naissance de Freddie Mercury, le chanteur de Queen. Sa maison natale dans Stone Town est devenue un lieu de pèlerinage pour les fans du monde entier. Il quitta l'île à 7 ans pour ne plus jamais y revenir.",hints:[
  ...
  {name:"Chobe — Botswana",lat:-17.8,lng:24.5,desc:"Le parc de Chobe accueille la plus grande concentration d'éléphants d'Afrique avec 120 000 individus. En saison sèche, les éléphants viennent par centaines boire à la rivière Chobe — créant des embouteillages d'éléphants sur les rives qui font le bonheur des photographes.",hints:[
  ...
  {name:"Parc Torres del Paine — Chili",lat:-51,lng:-73,desc:"Le nom «Paine» (prononcé Paï-né) vient du peuple Tehuelche qui signifie «bleu» en référence à la couleur des glaciers. Ces «Cornes de Paine» émergent de champs de glace vieux de 12 000 ans et alimentent des rivières qui coulent jusqu'à l'Atlantique.",hints:[
  ...
  {name:"Tikal — Guatemala",lat:17.222,lng:-89.6237,desc:"Les temples mayas de Tikal servirent de décor à la planète Yavin 4 dans Star Wars en 1977. George Lucas fit filmer les séquences de la Rébellion dans la forêt guatémaltèque, attirant depuis des millions de fans.",hints:[
  ...
  {name:"Delphes — Grèce",lat:38.4824,lng:22.501,desc:"L'oracle de Delphes était si influent que les Grecs et les rois étrangers venaient le consulter avant toute décision majeure. La Pythie rendait ses oracles dans une transe causée par des vapeurs géologiques — des chercheurs ont confirmé en 2001 l'existence de failles émettant de l'éthylène sous le temple d'Apollon.",hints:[
  ...
  {name:"Pont Charles — Prague, République Tchèque",lat:50.0865,lng:14.4114,desc:"Le pont Charles de Prague fut construit selon la numérologie médiévale : la première pierre fut posée le 9 juillet 1357 à 5h31 du matin, formant la séquence palindromique 1357 9 7 5 31. Cette date «magique» devait assurer la solidité éternelle du pont.",hints:[
    ...
    {bc:"#3a2008",tc:"#fde68a",l:"MOYEN",t:"Pont Charles aux statues baroques, Prague, République Tchèque"},
    {bc:"#052e16",tc:"#86efac",l:"FACILE",t:"Prague, capitale de la République Tchèque, sur la Vltava"},
    {bc:"#0c1a3e",tc:"#93c5fd",l:"TRÈS FACILE",t:"République Tchèque"}
  ]},
  {name:"Horloge astronomique — Prague, République Tchèque",lat:50.0872,lng:14.4205,desc:"L'Orloj de Prague est l'une des horloges astronomiques les plus anciennes encore en fonctionnement (1410). Selon la légende, le conseil municipal fit aveugler son créateur Maître Hanuš pour qu'il ne puisse jamais construire une horloge aussi parfaite ailleurs.",hints:[
  ...
  {name:"Château de Bojnice — Slovaquie",lat:48.7796,lng:18.5793,desc:"Le château de Bojnice est le château le plus visité de Slovaquie. Il fut profondément remanié en style néo-gothique romantique au XIXe siècle par le comte János Pálffy qui voulait créer un décor de conte de fées. Ses sous-sols abritent une grotte préhistorique naturelle intégrée au complexe.",hints:[
    ...
    {bc:"#3d1a05",tc:"#fdba74",l:"DIFFICILE",t:"Commune de Bojnice, région de Trenĝín, Slovaquie occidentale, à 20 km de Prievidza"},
    {bc:"#3a2008",tc:"#fde68a",l:"MOYEN",t:"Château de Bojnice, château féerique de Slovaquie"},
    {bc:"#052e16",tc:"#86efac",l:"FACILE",t:"Région de Trenĝín, Slovaquie, Carpates"},
    {bc:"#0c1a3e",tc:"#93c5fd",l:"TRÈS FACILE",t:"Slovaquie"}
  ]},
  {name:"Château de Hrad Spišský — Slovaquie",lat:49.0004,lng:20.768,desc:"Le château de Spiš est la plus grande forteresse médiévale d'Europe centrale avec ses 41 000 m². Construit au XIIe siècle sur une colline calcaire, il abrita des rois de Hongrie, des comtes palatins et résista à l'invasion mongole de 1241. Un incendie le détruisit partiellement en 1780.",hints:[
    ...
    {bc:"#3d1a05",tc:"#fdba74",l:"DIFFICILE",t:"District de Spišská Nová Ves, région de Košice, est de la Slovaquie, Haute Tatra"},
    {bc:"#3a2008",tc:"#fde68a",l:"MOYEN",t:"Château de Spiš, plus grande forteresse d'Europe centrale, Slovaquie"},
    {bc:"#052e16",tc:"#86efac",l:"FACILE",t:"Est de la Slovaquie, Hautes Tatras"},
    {bc:"#0c1a3e",tc:"#93c5fd",l:"TRÈS FACILE",t:"Slovaquie"}
  ]},
  {name:"Hallstatt — Autriche",lat:47.5622,lng:13.6493,desc:"Le cimetière de Hallstatt est si petit que les os exhumés après 10-12 ans sont décorés de motifs et placés dans une chapelle à crânes — la Beinhaus. Cette tradition unique perpétue la mémoire des défunts dans une ville où les morts dépassent les vivants.",hints:[
    ...
    {bc:"#3d1a05",tc:"#fdba74",l:"DIFFICILE",t:"District de Gmunden, Haute-Autriche, Salzkammergut, bord du lac Hallstatt"},
    {bc:"#3a2008",tc:"#fde68a",l:"MOYEN",t:"Village lacustre de Hallstatt, reflets dans le lac, Autriche"},
    {bc:"#052e16",tc:"#86efac",l:"FACILE",t:"Salzkammergut, Haute-Autriche, Alpes autrichiennes"},
    {bc:"#0c1a3e",tc:"#93c5fd",l:"TRÈS FACILE",t:"Autriche"}
  ]},
  {name:"Opéra de Vienne — Autriche",lat:48.2031,lng:16.3694,desc:"L'Opéra de Vienne présente 300 représentations par an avec quasi zéro répétitions : les chanteurs sont engagés pour un soir seulement. Son célèbre Bal de l'Opéra en février est l'événement mondain le plus couru d'Autriche, diffusé en direct à la télévision nationale.",hints:[
  ...
  {name:"Grossglockner — Autriche",lat:47.074,lng:12.693,desc:"Le Grossglockner (3 798 m) est le plus haut sommet d'Autriche et le point culminant de l'arc alpin oriental. Sa route panoramique à péage, l'une des plus belles d'Europe, grimpe à 2 504 mètres avec 36 virages en épingle. Le glacier Pasterze visible depuis la route a reculé de 3,5 km depuis 1850 — le plus rapide recul glaciaire d'Autriche.",hints:[
    ...
    {bc:"#3a2008",tc:"#fde68a",l:"MOYEN",t:"Grossglockner, plus haut sommet d'Autriche, Alpes centrales"},
    {bc:"#052e16",tc:"#86efac",l:"FACILE",t:"Alpes autrichiennes, Hohe Tauern, Autriche"},
    {bc:"#0c1a3e",tc:"#93c5fd",l:"TRÈS FACILE",t:"Autriche"}
  ]},
  {name:"Lac Bled — Slovénie (île)",lat:46.3631,lng:14.0944,desc:"L'île de Bled est la seule île naturelle de Slovénie. Sa cloche, fondue en 1534, est une des cloches «magiques» d'Europe : selon la tradition, les mariés qui gravissent ses 99 marches en portant leur épouse et sonnent la cloche trois fois voient leur vœu exaucé.",hints:[
    {bc:"#3b0f0f",tc:"#fca5a5",l:"EXPERT",t:"Otok, île de 2 270 m² avec l'église baroque de l'Assomption, tradition de la cloche aux vœux, seule île naturelle de Slovénie"},
    {bc:"#3d1a05",tc:"#fdba74",l:"DIFFICILE",t:"Lac de Bled, Haute-Carniole, Alpes juliennes, Slovénie"},
    {bc:"#3a2008",tc:"#fde68a",l:"MOYEN",t:"Île et église baroque du lac de Bled, Slovénie"},
    {bc:"#052e16",tc:"#86efac",l:"FACILE",t:"Alpes juliennes, Slovénie"},
    {bc:"#0c1a3e",tc:"#93c5fd",l:"TRÈS FACILE",t:"Slovénie"}
  ]},
  {name:"Grottes de Postojna — Slovénie",lat:45.7783,lng:14.2044,desc:"Les grottes de Postojna abritent le «protée» (Proteus anguinus), un amphibien aveugle qui peut vivre jusqu'à 100 ans et rester sans manger 12 ans. Cet animal translucide et dépourvu de pigmentation est surnommé «le dragon de caverne».",hints:[
    ...
    {bc:"#3d1a05",tc:"#fdba74",l:"DIFFICILE",t:"Commune de Postojna, Carniole intérieure, Slovénie, à 50 km de Ljubljana"},
    {bc:"#3a2008",tc:"#fde68a",l:"MOYEN",t:"Grottes de Postojna, réseau de galeries en train souterrain, Slovénie"},
    {bc:"#052e16",tc:"#86efac",l:"FACILE",t:"Carniole intérieure, Slovénie, Alpes dinariques"},
    {bc:"#0c1a3e",tc:"#93c5fd",l:"TRÈS FACILE",t:"Slovénie"}
  ]},
  {name:"Vallée de la Soĝa — Slovénie",lat:46.34,lng:13.65,desc:"La Statue de la Liberté fut offerte par la France mais les Américains durent financer eux-mêmes son piédestal. Joseph Pulitzer lança une collecte publique dans son journal, récoltant 100 000 dollars en moins de six mois.",hints:[
    ...
    {bc:"#3a2008",tc:"#fde68a",l:"MOYEN",t:"Rivière Soĝa aux eaux émeraude, Alpes juliennes, Slovénie"},
    {bc:"#052e16",tc:"#86efac",l:"FACILE",t:"Nord-ouest de la Slovénie, Alpes juliennes"},
    {bc:"#0c1a3e",tc:"#93c5fd",l:"TRÈS FACILE",t:"Slovénie"}
  ]},
  {name:"Marché central — Budapest, Hongrie",lat:47.487,lng:19.06,desc:"La Grande Halle de Budapest fut inaugurée en 1897 et couvre 10 000 m². Ses galeries du premier étage proposent de la broderie hongroise et du paprika depuis un siècle. Son toit en tuiles vernissées Zsolnay est orné de motifs inspirés de l'art populaire magyar — une caractéristique de l'architecture Art Nouveau budapestois.",hints:[
    {bc:"#3b0f0f",tc:"#fca5a5",l:"EXPERT",t:"Nagy Vásárcsarnok, plus grande halle couverte de Hongrie (1897), toits en tuiles Zsolnay, paprika, tokay et foie gras"},
    {bc:"#3d1a05",tc:"#fdba74",l:"DIFFICILE",t:"Fővám tér, Pest, bord du Danube, Budapest, Hongrie"},
    {bc:"#3a2008",tc:"#fde68a",l:"MOYEN",t:"Grand marché central de Budapest, halle de 1897"},
    {bc:"#052e16",tc:"#86efac",l:"FACILE",t:"Budapest, capitale de la Hongrie, bord du Danube"},
    {bc:"#0c1a3e",tc:"#93c5fd",l:"TRÈS FACILE",t:"Hongrie"}
  ]},
  {name:"Thermes Széchenyi — Budapest, Hongrie",lat:47.5189,lng:19.0823,desc:"Les thermes Széchenyi, inaugurés en 1913, sont alimentés par deux sources thermales naturelles jaillissant à 74°C et 77°C. Avec leurs 18 bassins, ils sont les plus grands bains thermaux d'Europe. Les Budapestois y jouent aux échecs dans les piscines extérieures — une tradition photographiée dans le monde entier.",hints:[
    {bc:"#3b0f0f",tc:"#fca5a5",l:"EXPERT",t:"Széchenyi gyógyfürdő, plus grands bains thermaux d'Europe (1913), eau à 74-76°C, 3 piscines extérieures, Városliget"},
    {bc:"#3d1a05",tc:"#fdba74",l:"DIFFICILE",t:"Ýllatkerti körút 11, Városliget (bois de la ville), Budapest, Hongrie"},
    {bc:"#3a2008",tc:"#fde68a",l:"MOYEN",t:"Thermes Széchenyi, plus grands bains chauds d'Europe, Budapest"},
    {bc:"#052e16",tc:"#86efac",l:"FACILE",t:"Budapest, capitale de la Hongrie"},
    {bc:"#0c1a3e",tc:"#93c5fd",l:"TRÈS FACILE",t:"Hongrie"}
  ]},
  {name:"Château d'If — Marseille, France",lat:43.2796,lng:5.325,desc:"Le château d'If, forteresse construite en 1524 sur une île du large de Marseille, abrita les prisonniers d'État les plus dangereux, dont le «masque de fer». Alexandre Dumas en fit la prison fictive du Comte de Monte-Cristo — le roman lui valut un tel succès que des touristes vinrent chercher «la cellule de Dantès».",hints:[
  ...
  {name:"Gorges de l'Ardèche — France",lat:44.331,lng:4.42,desc:"Le Pont d'Arc, arche naturelle de 60 mètres de haut et 59 de large dans les gorges de l'Ardèche, est le plus grand arc naturel d'Europe. La grotte Chauvet, découverte à 2 km, abrite les peintures rupestres les plus anciennes du monde (-36 000 ans), classées UNESCO en 2014.",hints:[
    ...
    {bc:"#3a2008",tc:"#fde68a",l:"MOYEN",t:"Gorges de l'Ardèche, pont d'Arc naturel, canoë, France"},
    {bc:"#052e16",tc:"#86efac",l:"FACILE",t:"Ardèche, Auvergne-Rhône-Alpes, France"},
    {bc:"#0c1a3e",tc:"#93c5fd",l:"TRÈS FACILE",t:"France"}
  ]},
  {name:"Île de Ré — France",lat:46.2,lng:-1.42,desc:"La citadelle de Saint-Martin-de-Ré, sur l'île de Ré, fut utilisée comme prison d'où partaient les condamnés au bagne de Guyane jusqu'en 1938. Albert Camus s'y inspira pour écrire «L'Étranger» lors d'un séjour sur l'île.",hints:[
    ...
    {bc:"#3a2008",tc:"#fde68a",l:"MOYEN",t:"Île de Ré, île blanche au large de La Rochelle, Charente-Maritime"},
    {bc:"#052e16",tc:"#86efac",l:"FACILE",t:"Charente-Maritime, côte atlantique, France"},
    {bc:"#0c1a3e",tc:"#93c5fd",l:"TRÈS FACILE",t:"France"}
  ]},
  {name:"Phare de Cordouan — France",lat:45.5825,lng:-1.1748,desc:"Le phare de Cordouan, surnommé «le Roi des phares», est le plus ancien phare habité de France encore en activité. Construit à partir de 1584 par Louis de Foix, il possède une chapelle royale, un appartement pour le roi et des appartements pour les gardiens. Classé UNESCO en 2021.",hints:[
    ...
    {bc:"#3a2008",tc:"#fde68a",l:"MOYEN",t:"Phare de Cordouan, roi des phares, estuaire de la Gironde, France"},
    {bc:"#052e16",tc:"#86efac",l:"FACILE",t:"Estuaire de la Gironde, Nouvelle-Aquitaine, France"},
    {bc:"#0c1a3e",tc:"#93c5fd",l:"TRÈS FACILE",t:"France"}
  ]},
  {name:"Puy de Dôme — Auvergne, France",lat:45.7723,lng:2.9651,desc:"Pascal fit monter du mercure au sommet du Puy de Dôme en 1648 pour prouver que la pression atmosphérique diminuait avec l'altitude — une expérience fondatrice de la physique moderne. Il ne fit pas l'ascension lui-même, mais demanda à son beau-frère.",hints:[
  ...
  {name:"Abbaye de Fontevraud — France",lat:47.1784,lng:0.053,desc:"L'abbaye de Fontevraud est la plus grande abbaye médiévale de France. Elle renferme les gisants de Richard Cœur de Lion, Aliénor d'Aquitaine et Henri II Plantagenêt. Transformée en prison napoléonienne de 1804 à 1963, elle garde encore les cellules dans sa nef — un mélange saisissant du sacré et du carcéral.",hints:[
    ...
    {bc:"#3a2008",tc:"#fde68a",l:"MOYEN",t:"Abbaye de Fontevraud, nécropole royale Plantagenêt, Maine-et-Loire"},
    {bc:"#052e16",tc:"#86efac",l:"FACILE",t:"Maine-et-Loire, val de Loire, France"},
    {bc:"#0c1a3e",tc:"#93c5fd",l:"TRÈS FACILE",t:"France"}
  ]},
  {name:"Cap Blanc-Nez — France",lat:50.9217,lng:1.712,desc:"Le Cap Blanc-Nez, falaise de craie de 134 mètres face à l'Angleterre visible à seulement 34 km, fut l'un des points de départ des premiers traversées de la Manche à la nage. Il abrite le monument de Dover Patrol, commémorant les milliers de marins franco-britanniques morts en mer durant la Première Guerre mondiale.",hints:[
    ...
    {bc:"#3a2008",tc:"#fde68a",l:"MOYEN",t:"Cap Blanc-Nez, falaises de la Côte d'Opale, proche de l'Angleterre"},
    {bc:"#052e16",tc:"#86efac",l:"FACILE",t:"Pas-de-Calais, Côte d'Opale, nord de la France"},
    {bc:"#0c1a3e",tc:"#93c5fd",l:"TRÈS FACILE",t:"France"}
  ]},
  {name:"Dunes du Pilat — Arcachon, France",lat:44.5876,lng:-1.2128,desc:"La dune du Pilat est la plus haute d'Europe et continue de progresser de 1 à 5 mètres par an vers la forêt de pins. Elle a déjà englouti une route, un camping et une maison depuis le début du XXe siècle.",hints:[
    ...
    {bc:"#052e16",tc:"#86efac",l:"FACILE",t:"Bassin d'Arcachon, Gironde, Nouvelle-Aquitaine, France"},
    {bc:"#0c1a3e",tc:"#93c5fd",l:"TRÈS FACILE",t:"France"}
  ]},
  {name:"Abbaye du Thoronet — Provence, France",lat:43.4699,lng:6.3193,desc:"L'acoustique de l'abbaye du Thoronet est si parfaite que les moines cisterciens pouvaient chanter a cappella dans la nef sans aucun équipement d'amplification. Le musicien américain Jonathan Harvey y composa une œuvre inspirée par sa réverbération de 1,8 secondes.",hints:[
    ...
    {bc:"#3a2008",tc:"#fde68a",l:"MOYEN",t:"Abbaye du Thoronet, chef-d'œuvre cistercien de Provence, Var"},
    {bc:"#052e16",tc:"#86efac",l:"FACILE",t:"Var, Provence, sud-est de la France"},
    {bc:"#0c1a3e",tc:"#93c5fd",l:"TRÈS FACILE",t:"France"}
  ]},
  {name:"Alberobello — Puglia, Italie",lat:40.7882,lng:17.2394,desc:"Les trulli d'Alberobello sont des constructions coniques en calcaire sans mortier héritées d'une technique préhistorique. Au XVIIe siècle, leurs toits amovibles permettaient aux habitants de démolir rapidement leurs maisons pour éviter les taxes royales — une maison sans toit n'étant pas considérée comme habitée.",hints:[
  ...
  {name:"Syracuse — Sicile, Italie",lat:37.0655,lng:15.2866,desc:"Syracuse fut l'une des plus grandes villes du monde antique au Ve siècle av. J.-C., rivalisant avec Athènes et Carthage. Son théâtre grec taillé dans le roc accueille toujours des représentations de tragédies grecques chaque printemps. Archimède y naquit vers -287 et défendit la ville contre les Romains avec ses machines de guerre.",hints:[
    ...
    {bc:"#3a2008",tc:"#fde68a",l:"MOYEN",t:"Syracuse, cité grecque antique, île d'Ortygie, Sicile"},
    {bc:"#052e16",tc:"#86efac",l:"FACILE",t:"Sicile orientale, Italie"},
    {bc:"#0c1a3e",tc:"#93c5fd",l:"TRÈS FACILE",t:"Italie"}
  ]},
  {name:"Palerme — Sicile (Cappella Palatina)",lat:38.1111,lng:13.3554,desc:"La Cappella Palatina de Palerme (1143) est un chef-d'œuvre de l'art normanno-arabe-byzantin : ses mosaïques dorées byzantines recouvrent des plafonds en bois de style islamique avec des inscriptions en arabe — un syncrétisme culturel unique du règne de Roger II de Sicile.",hints:[
    ...
    {bc:"#3a2008",tc:"#fde68a",l:"MOYEN",t:"Chapelle Palatine de Palerme, mosaïques byzantines, Sicile"},
    {bc:"#052e16",tc:"#86efac",l:"FACILE",t:"Palerme, capitale de la Sicile, Italie"},
    {bc:"#0c1a3e",tc:"#93c5fd",l:"TRÈS FACILE",t:"Italie"}
  ]},
  ...
  {name:"Vallée des Temples — Agrigente, Italie",lat:37.2908,lng:13.5881,desc:"Les temples grecs d'Agrigente, vieux de 2 500 ans, sont mieux conservés que la plupart des temples de Grèce elle-même. Le Temple de la Concordia doit sa survie au fait qu'il fut transformé en église chrétienne au VIe siècle, ce qui évita son démantèlement.",hints:[
    ...
    {bc:"#3a2008",tc:"#fde68a",l:"MOYEN",t:"Vallée des temples grecs d'Agrigente, Sicile, UNESCO"},
    {bc:"#052e16",tc:"#86efac",l:"FACILE",t:"Agrigente, côte sud de la Sicile, Italie"},
    {bc:"#0c1a3e",tc:"#93c5fd",l:"TRÈS FACILE",t:"Italie"}
  ]},
  {name:"Marrakech — Maroc (Djemaa el-Fna)",lat:31.6258,lng:-7.9892,desc:"La place Djemaa el-Fna de Marrakech est classée par l'UNESCO comme patrimoine immatériel de l'humanité — une première pour un espace public. Elle se transforme chaque soir en gigantesque restaurant en plein air avec des dizaines de stands de cuisine.",hints:[
    ...
    {bc:"#3a2008",tc:"#fde68a",l:"MOYEN",t:"Place Djemaa el-Fna, cœur de la médina de Marrakech, Maroc"},
    {bc:"#052e16",tc:"#86efac",l:"FACILE",t:"Marrakech, ville rouge, pied de l'Atlas, Maroc"},
    {bc:"#0c1a3e",tc:"#93c5fd",l:"TRÈS FACILE",t:"Maroc"}
  ]},
  {name:"Palmeraie de Skoura — Maroc",lat:31.06,lng:-6.56,desc:"La palmeraie de Skoura abrite des ksour — châteaux de pisé — dont certains sont habités depuis le XVIIe siècle. Ces forteresses en terre crue, construites sans architecte, résistent mieux aux séismes que nombre de constructions modernes.",hints:[
    ...
    {bc:"#3a2008",tc:"#fde68a",l:"MOYEN",t:"Palmeraie de Skoura, oasis et ksour, route des kasbahs, Maroc"},
    {bc:"#052e16",tc:"#86efac",l:"FACILE",t:"Province d'Ouarzazate, pré-Sahara, Maroc"},
    {bc:"#0c1a3e",tc:"#93c5fd",l:"TRÈS FACILE",t:"Maroc"}
  ]},
  {name:"Oasis de Dakhla — Maroc",lat:23.7136,lng:-15.9355,desc:"Dakhla est une péninsule de 40 km formant le lagon le plus parfait de l'Atlantique pour les sports de glisse. Ses vents constants de force 4-5 Beaufort et ses eaux peu profondes turquoise en font la capitale mondiale du kitesurf. Jacques-Yves Cousteau l'explorait dans les années 1970, fasciné par la richesse de ses fonds marins.",hints:[
    ...
    {bc:"#052e16",tc:"#86efac",l:"FACILE",t:"Sahara occidental, côte atlantique, Maroc"},
    {bc:"#0c1a3e",tc:"#93c5fd",l:"TRÈS FACILE",t:"Maroc (Sahara occidental)"}
  ]},
  {name:"Gondar — Éthiopie (Fasiladas)",lat:12.603,lng:37.464,desc:"Gondar, surnommée «Camelot africain», abrite le Fasil Ghebbi — enceinte royale du XVIIe siècle comprenant 5 châteaux. L'influence des architectes indiens, arabes et portugais crée un style architectural unique. La piscine de Fasiladas se remplit une fois par an pour le festival Timkat (Épiphanie) — des milliers de fidèles s'y plongent.",hints:[
    ...
    {bc:"#3d1a05",tc:"#fdba74",l:"DIFFICILE",t:"Région d'Amhara, Gondar, nord-ouest de l'Éthiopie, à 730 km d'Addis-Abeba"},
    {bc:"#3a2008",tc:"#fde68a",l:"MOYEN",t:"Enceinte royale de Gondar, Camelot africain, Éthiopie"},
    {bc:"#052e16",tc:"#86efac",l:"FACILE",t:"Gondar, région d'Amhara, nord-ouest de l'Éthiopie"},
    {bc:"#0c1a3e",tc:"#93c5fd",l:"TRÈS FACILE",t:"Éthiopie"}
  ]},
  {name:"Parc de l'Etosha — Namibie",lat:-18.856,lng:16.329,desc:"La dépression salée d'Etosha était autrefois un lac intérieur immense. Asséché il y a des millénaires, son lit de sel blanc est maintenant visible depuis l'espace. En saison sèche, les éléphants, lions, rhinocéros et zèbres convergent vers les seuls points d'eau — offrant des scènes de safari uniques.",hints:[
    ...
    {bc:"#3d1a05",tc:"#fdba74",l:"DIFFICILE",t:"Région de Oshikoto, nord de la Namibie, à 500 km de Windhoek"},
    {bc:"#3a2008",tc:"#fde68a",l:"MOYEN",t:"Parc d'Etosha, grande plaine de sel, safari nocturne, Namibie"},
    {bc:"#052e16",tc:"#86efac",l:"FACILE",t:"Nord de la Namibie, Afrique australe"},
    {bc:"#0c1a3e",tc:"#93c5fd",l:"TRÈS FACILE",t:"Namibie"}
  ]},
  {name:"Lamu — Kenya",lat:-2.2694,lng:40.9022,desc:"La vieille ville de Lamu est la seule ville swahilie médiévale encore habitée et quasiment intacte. Elle ne compte aucune voiture ni moto — les ânes et les bateaux sont les seuls moyens de transport, comme depuis des siècles.",hints:[
    {bc:"#3b0f0f",tc:"#fca5a5",l:"EXPERT",t:"Vieille ville de Lamu, plus ancienne ville swahilie habitée du Kenya, pas de voitures, ânes et boutres, UNESCO 2001"},
    {bc:"#3d1a05",tc:"#fdba74",l:"DIFFICILE",t:"Île de Lamu, comté de Lamu, côte nord du Kenya, océan Indien"},
    {bc:"#3a2008",tc:"#fde68a",l:"MOYEN",t:"Lamu, vieille ville swahilie sans voitures, archipel de Lamu, Kenya"},
    {bc:"#052e16",tc:"#86efac",l:"FACILE",t:"Côte nord du Kenya, archipel de Lamu, océan Indien"},
    {bc:"#0c1a3e",tc:"#93c5fd",l:"TRÈS FACILE",t:"Kenya"}
  ]},
  {name:"Chutes de Tugela — Afrique du Sud",lat:-28.7536,lng:29.2047,desc:"Les chutes de Tugela plongent en 5 sauts successifs depuis le sommet du Drakensberg. En hiver, l'eau gèle partiellement, créant des cascades de glace spectaculaires visibles uniquement depuis les hauteurs.",hints:[
  ...
  {name:"Lac Malawi — Malawi",lat:-12,lng:34.5,desc:"Le lac Malawi abrite plus d'espèces de poissons d'eau douce que tout autre lac — près de 1 000 espèces de cichlidés endémiques. Son eau si transparente permet de voir jusqu'à 20 mètres de profondeur. Le lac occupe 20% de la surface du Malawi et représente la principale ressource en protéines animales du pays.",hints:[
    ...
    {bc:"#3d1a05",tc:"#fdba74",l:"DIFFICILE",t:"Grand Rift africain, frontières Malawi-Mozambique-Tanzanie, Afrique centrale orientale"},
    {bc:"#3a2008",tc:"#fde68a",l:"MOYEN",t:"Lac Malawi, lac aux cichlidés endémiques, Afrique centrale"},
    {bc:"#052e16",tc:"#86efac",l:"FACILE",t:"Malawi, Mozambique, Tanzanie, Afrique centrale"},
    {bc:"#0c1a3e",tc:"#93c5fd",l:"TRÈS FACILE",t:"Malawi"}
  ]},
  {name:"Boulders Beach — Afrique du Sud",lat:-34.1979,lng:18.4511,desc:"La colonie de manchots de Boulders Beach fut fondée par seulement deux couples en 1982. Elle compte aujourd'hui plus de 3 000 individus. Ces manchots africains (Spheniscus demersus) sont classés «en danger» — leur population mondiale a diminué de 70% depuis 1970.",hints:[
  ...
  {name:"Ephèse — Turquie (bibliothèque)",lat:37.9395,lng:27.3417,desc:"La bibliothèque de Celse d'Éphèse, construite en 135 ap. J.-C., abritait 12 000 rouleaux de parchemin. Sa façade crée une illusion d'optique : des colonnes centrales plus grandes la font paraître plus haute qu'elle n'est. La tombe du consul Gaïus Julius Celsus se trouve directement sous le bâtiment qu'il finança.",hints:[
    ...
    {bc:"#3d1a05",tc:"#fdba74",l:"DIFFICILE",t:"Cité romaine d'Éphèse, Selçuk, province d'İzmir, côte égéenne"},
    {bc:"#3a2008",tc:"#fde68a",l:"MOYEN",t:"Bibliothèque de Celse, joyau d'Éphèse, côte égéenne turque"},
    {bc:"#052e16",tc:"#86efac",l:"FACILE",t:"Éphèse, province d'İzmir, côte égéenne, Turquie"},
    {bc:"#0c1a3e",tc:"#93c5fd",l:"TRÈS FACILE",t:"Turquie"}
  ]},
  {name:"Aspendos — Turquie",lat:36.9384,lng:31.1715,desc:"Le théâtre d'Aspendos, construit au IIe siècle ap. J.-C., peut accueillir 15 000 spectateurs et est si bien conservé qu'il accueille encore aujourd'hui le festival international d'opéra d'Aspendos chaque été. Sa scène de 21 mètres de haut est la seule de cette époque encore intacte dans le monde méditerranéen.",hints:[
    ...
    {bc:"#3a2008",tc:"#fde68a",l:"MOYEN",t:"Théâtre romain d'Aspendos, mieux conservé du monde, Antalya, Turquie"},
    {bc:"#052e16",tc:"#86efac",l:"FACILE",t:"Province d'Antalya, côte sud de la Turquie"},
    {bc:"#0c1a3e",tc:"#93c5fd",l:"TRÈS FACILE",t:"Turquie"}
  ]},
  {name:"Yosemite — Californie, USA",lat:37.7456,lng:-119.5936,desc:"El Capitan, la paroi granitique verticale de 914 mètres de Yosemite, fut gravi pour la première fois sans équipement d'aide en 2017 par Alex Honnold. Cette ascension en solo intégral fut qualifiée de «plus grande prouesse athlétique de tous les temps».",hints:[
    ...
    {bc:"#3a2008",tc:"#fde68a",l:"MOYEN",t:"Parc national Yosemite, El Capitan et Half Dome, Sierra Nevada"},
    {bc:"#052e16",tc:"#86efac",l:"FACILE",t:"Sierra Nevada, centre de la Californie, États-Unis"},
    {bc:"#0c1a3e",tc:"#93c5fd",l:"TRÈS FACILE",t:"États-Unis"}
  ]},
  {name:"Zion Canyon — Utah, USA",lat:37.2982,lng:-113.0263,desc:"Angels Landing dans Zion Canyon est l'une des randonnées les plus dangereuses d'Amérique. 6 personnes sont mortes en chutant depuis 2004, mais l'affluence record de 4 millions de visiteurs par an a conduit à l'instauration d'un permis de tirage au sort en 2022.",hints:[
  ...
  {name:"Bryce Canyon — Utah, USA",lat:37.593,lng:-112.1871,desc:"Les «hoodoos» de Bryce Canyon se forment en 3 millions d'années grâce à l'alternance gel-dégel qui brise la roche. Le parc perd environ 30 cm de ses formations par tranche de 50 à 65 ans — un déclin imperceptible à l'échelle humaine mais constant.",hints:[
    ...
    {bc:"#3a2008",tc:"#fde68a",l:"MOYEN",t:"Bryce Canyon, forêt de cheminées de fées orange, Utah"},
    {bc:"#052e16",tc:"#86efac",l:"FACILE",t:"Utah, plateau Colorado, sud-ouest des États-Unis"},
    {bc:"#0c1a3e",tc:"#93c5fd",l:"TRÈS FACILE",t:"États-Unis"}
  ]},
  {name:"Death Valley — Californie, USA",lat:36.5232,lng:-116.9325,desc:"La Vallée de la Mort détient le record mondial de température enregistrée (56,7°C en 1913). Paradoxalement, elle accueille des fleurs sauvages spectaculaires lors des «superblooms» rares, quand les graines dormantes germent après une pluie exceptionnelle.",hints:[
    ...
    {bc:"#052e16",tc:"#86efac",l:"FACILE",t:"Frontière Californie-Nevada, Mojave, États-Unis"},
    {bc:"#0c1a3e",tc:"#93c5fd",l:"TRÈS FACILE",t:"États-Unis"}
  ]},
  {name:"Arches National Park — Utah, USA",lat:38.7331,lng:-109.5925,desc:"Le parc des Arches contient plus de 2 000 arches naturelles en grès rouge sur une superficie de 300 km². La Delicate Arch, haute de 16 mètres, est l'emblème de l'Utah imprimé sur les plaques d'immatriculation de l'État. En 2008, Wall Arch, l'une des plus grandes, s'effondra brusquement dans la nuit.",hints:[
  ...
  {name:"Seattle Space Needle — USA",lat:47.6205,lng:-122.3493,desc:"La Space Needle de Seattle fut construite en 398 jours pour l'Exposition universelle de 1962. Son restaurant tournant SkyCity effectue une rotation complète en 47 minutes. Elle fut conçue pour résister à des vents de 300 km/h et à un séisme de magnitude 9,1 — plus puissant que le grand séisme de Seattle de 1965.",hints:[
    ...
    {bc:"#052e16",tc:"#86efac",l:"FACILE",t:"Seattle, État de Washington, côte nord-ouest des États-Unis"},
    {bc:"#0c1a3e",tc:"#93c5fd",l:"TRÈS FACILE",t:"États-Unis"}
  ]},
  {name:"Chicago Cloud Gate — USA",lat:41.8827,lng:-87.6233,desc:"Cloud Gate d'Anish Kapoor, surnommée «The Bean», est faite de 168 plaques d'acier inoxydable soudées sans aucun joint visible. Elle réfléchit le skyline de Chicago en le déformant. Ses 110 tonnes reposent sur seulement 6 pieds d'ancrage — son poids est compensé par une structure enterrée dans le sol du parc.",hints:[
    ...
    {bc:"#052e16",tc:"#86efac",l:"FACILE",t:"Chicago, Illinois, bord du lac Michigan, États-Unis"},
    {bc:"#0c1a3e",tc:"#93c5fd",l:"TRÈS FACILE",t:"États-Unis"}
  ]},
  {name:"Niagara on the Lake — Canada",lat:43.2554,lng:-79.0713,desc:"Niagara-on-the-Lake fut la première capitale du Haut-Canada en 1792. Brûlée par les Américains en 1813, elle fut reconstruite dans un style géorgien homogène. Son architecture victorienne si parfaitement préservée lui vaut le titre de «ville la plus jolie du Canada».",hints:[
  ...
  {name:"Gaspésie — Québec, Canada",lat:49,lng:-65,desc:"Le Rocher Percé de Gaspésie compte parmi les plus grandes roches percées au monde — son arche mesure 20 mètres de haut. L'île Bonaventure voisine héberge l'une des plus grandes colonies de fous de Bassan accessibles au monde, avec 100 000 couples nicheurs.",hints:[
    ...
    {bc:"#3d1a05",tc:"#fdba74",l:"DIFFICILE",t:"Péninsule gaspésienne, golfe du Saint-Laurent, Québec, Canada"},
    {bc:"#3a2008",tc:"#fde68a",l:"MOYEN",t:"Gaspésie, rocher Percé et fous de Bassan, Québec, Canada"},
    {bc:"#052e16",tc:"#86efac",l:"FACILE",t:"Péninsule gaspésienne, Québec, golfe du Saint-Laurent"},
    {bc:"#0c1a3e",tc:"#93c5fd",l:"TRÈS FACILE",t:"Canada"}
  ]},
  {name:"Churchill — Manitoba, Canada (ours polaires)",lat:58.7684,lng:-94.165,desc:"Les ours polaires de Churchill se rassemblent en attendant que la baie d'Hudson gèle pour aller chasser le phoque. La ville est la seule au monde où vous pouvez observer des ours polaires sauvages depuis des véhicules spéciaux à l'automne, avant qu'ils ne migrent sur la glace.",hints:[
    ...
    {bc:"#3d1a05",tc:"#fdba74",l:"DIFFICILE",t:"Manitoba, bord de la baie d'Hudson, nord du Canada, accessible en train ou avion"},
    {bc:"#3a2008",tc:"#fde68a",l:"MOYEN",t:"Churchill, capitale des ours polaires, baie d'Hudson, Manitoba"},
    {bc:"#052e16",tc:"#86efac",l:"FACILE",t:"Manitoba, nord du Canada, baie d'Hudson"},
    {bc:"#0c1a3e",tc:"#93c5fd",l:"TRÈS FACILE",t:"Canada"}
  ]},
  {name:"Baie de Fundy — Nouveau-Brunswick, Canada",lat:45.2,lng:-65,desc:"Les marées de la Baie de Fundy, les plus grandes du monde, déplacent 160 milliards de tonnes d'eau à chaque cycle. Les rochers de Hopewell, qui ressemblent à des pots de fleurs géants à marée haute, sont entièrement submergés et inaccessibles 6 heures après.",hints:[
    ...
    {bc:"#3d1a05",tc:"#fdba74",l:"DIFFICILE",t:"Entre Nouveau-Brunswick et Nouvelle-Écosse, Canada, golfe du Saint-Laurent"},
    {bc:"#3a2008",tc:"#fde68a",l:"MOYEN",t:"Baie de Fundy, marées record, Rochers Hopewell, Nouveau-Brunswick"},
    {bc:"#052e16",tc:"#86efac",l:"FACILE",t:"Nouveau-Brunswick, Canada atlantique"},
    {bc:"#0c1a3e",tc:"#93c5fd",l:"TRÈS FACILE",t:"Canada"}
  ]},
  {name:"Chichen Itza — Mexique (cenote)",lat:20.6776,lng:-88.5681,desc:"La grande cénote sacrée de Chichen Itza livra lors de fouilles au XXe siècle des dizaines de squelettes, bijoux de jade et objets en or — confirmant les sacrifices mayas. On estime que des milliers d'offrandes reposent encore au fond inaccessible du puits.",hints:[
    {bc:"#3b0f0f",tc:"#fca5a5",l:"EXPERT",t:"Cenote Sagrado (Xtoloc), puits de 60m de diamètre, sacrifices mayas de jade et d'or, Thompson y plongea en 1904"},
    {bc:"#3d1a05",tc:"#fdba74",l:"DIFFICILE",t:"Chichen Itza, municipalité de Tinum, État du Yucatán, Mexique"},
    {bc:"#3a2008",tc:"#fde68a",l:"MOYEN",t:"Cenote sacré de Chichen Itza, puits aux sacrifices mayas, Yucatán"},
    {bc:"#052e16",tc:"#86efac",l:"FACILE",t:"Yucatán, Mexique, péninsule caribéenne"},
    {bc:"#0c1a3e",tc:"#93c5fd",l:"TRÈS FACILE",t:"Mexique"}
  ]},
  {name:"Colca Canyon — Pérou",lat:-15.5279,lng:-71.8861,desc:"Le Colca Canyon de Pérou est le canyon le plus profond de l'hémisphère occidental. Le condor des Andes, le plus grand oiseau volant au monde avec ses 3,2 m d'envergure, y plane en cercles depuis le belvédère de la Cruz del Cóndor — un spectacle quotidien à l'aube.",hints:[
    ...
    {bc:"#052e16",tc:"#86efac",l:"FACILE",t:"Région d'Arequipa, Andes péruviennes, Pérou"},
    {bc:"#0c1a3e",tc:"#93c5fd",l:"TRÈS FACILE",t:"Pérou"}
  ]},
  ...
  {name:"Carnaval de Barranquilla — Colombie",lat:10.9878,lng:-74.7889,desc:"Le carnaval de Barranquilla est le deuxième plus grand carnaval du monde après Rio. Classé patrimoine immatériel de l'UNESCO en 2003, il fusionne les traditions africaines, indigènes et espagnoles. Sa Batalla de Flores (bataille de fleurs), la Grand Parade et le Garabato (danse de la mort et de la vie) durent 4 jours avant le Mardi Gras.",hints:[
    ...
    {bc:"#3a2008",tc:"#fde68a",l:"MOYEN",t:"Carnaval de Barranquilla, 2e plus grand du monde, Colombie"},
    {bc:"#052e16",tc:"#86efac",l:"FACILE",t:"Barranquilla, côte caraïbe de la Colombie"},
    {bc:"#0c1a3e",tc:"#93c5fd",l:"TRÈS FACILE",t:"Colombie"}
  ]},
  {name:"Roraima — Venezuela (tepui)",lat:5.143,lng:-60.762,desc:"Le mont Roraima (2 810 m) est un tepui — une montagne-table de grès précambrien vieille de 1,8 milliard d'années. Son sommet de 31 km², toujours dans les nuages, abrite des espèces végétales uniques dont 35% sont endémiques. Arthur Conan Doyle s'en inspira pour «Le Monde Perdu» (1912) — un plateau où dinosaures et créatures primitives survivraient.",hints:[
    {bc:"#3b0f0f",tc:"#fca5a5",l:"EXPERT",t:"Mount Roraima (2 810m), tepui de 31 km² à sommet plat, tripoint Venezuela-Brésil-Guyana, inspiration pour Le Monde Perdu de Conan "},
    {bc:"#3d1a05",tc:"#fdba74",l:"DIFFICILE",t:"Parc national Canaima, État de Bolivar, Venezuela, frontière Brésil-Guyana"},
    {bc:"#3a2008",tc:"#fde68a",l:"MOYEN",t:"Tepui Roraima, montagne tabletop, Venezuela"},
    {bc:"#052e16",tc:"#86efac",l:"FACILE",t:"Gran Sabana, Venezuela, Amérique du Sud"},
    {bc:"#0c1a3e",tc:"#93c5fd",l:"TRÈS FACILE",t:"Venezuela"}
  ]},
  {name:"Lençóis Maranhenses — Brésil",lat:-2.4943,lng:-43.1291,desc:"Les dunes des Lençóis Maranhenses se forment et se déplacent chaque année. Malgré leur apparence désertique, les lacs qui s'y forment entre juin et septembre accueillent des piranhas, des raies et des tortues aquatiques — ramenés par les poissons lors des crues.",hints:[
    {bc:"#3b0f0f",tc:"#fca5a5",l:"EXPERT",t:"155 000 ha de dunes blanches de quartz avec lacs temporaires bleu turquoise de juin à septembre, État du Maranhão"},
    {bc:"#3d1a05",tc:"#fdba74",l:"DIFFICILE",t:"Commune de Barreirinhas, État du Maranhão, nord-est du Brésil, côte atlantique"},
    {bc:"#3a2008",tc:"#fde68a",l:"MOYEN",t:"Lençóis Maranhenses, dunes blanches aux lacs turquoise, Maranhão, Brésil"},
    {bc:"#052e16",tc:"#86efac",l:"FACILE",t:"État du Maranhão, nord-est du Brésil"},
    {bc:"#0c1a3e",tc:"#93c5fd",l:"TRÈS FACILE",t:"Brésil"}
  ]},
  {name:"Ouro Preto — Minas Gerais, Brésil",lat:-20.3867,lng:-43.5036,desc:"Ouro Preto (or brut) fut l'épicentre de la ruée vers l'or du XVIIIe siècle qui fit du Brésil le premier producteur mondial. La ville draina tellement de richesses que le Portugal put financer la reconstruction de Lisbonne après le tremblement de terre de 1755.",hints:[
    ...
    {bc:"#3d1a05",tc:"#fdba74",l:"DIFFICILE",t:"État du Minas Gerais, Serra do Espinhaço, à 95 km de Belo Horizonte, Brésil"},
    {bc:"#3a2008",tc:"#fde68a",l:"MOYEN",t:"Ouro Preto, ville coloniale baroque de l'or, Minas Gerais, Brésil"},
    {bc:"#052e16",tc:"#86efac",l:"FACILE",t:"Minas Gerais, Brésil"},
    {bc:"#0c1a3e",tc:"#93c5fd",l:"TRÈS FACILE",t:"Brésil"}
  ]},
  {name:"Salvador de Bahia — Brésil",lat:-13.0102,lng:-38.5018,desc:"Salvador de Bahia fut le premier port négrier de l'histoire et reçut 4 millions d'esclaves africains — plus que n'importe quelle autre ville du monde. Aujourd'hui, sa culture — musique, cuisine, religion — reste profondément marquée par l'héritage africain.",hints:[
    {bc:"#3b0f0f",tc:"#fca5a5",l:"EXPERT",t:"Pelourinho, quartier historique colonial, Église São Francisco aux 800 kg d'or, capoeira et candomblé, première capitale du Brésil"},
    {bc:"#3d1a05",tc:"#fdba74",l:"DIFFICILE",t:"État de Bahia, Nordeste brésilien, baie de Todos os Santos, Brésil"},
    {bc:"#3a2008",tc:"#fde68a",l:"MOYEN",t:"Salvador de Bahia, capitale afro-brésilienne, Pelourinho baroque"},
    {bc:"#052e16",tc:"#86efac",l:"FACILE",t:"Bahia, Nordeste brésilien, Brésil"},
    {bc:"#0c1a3e",tc:"#93c5fd",l:"TRÈS FACILE",t:"Brésil"}
  ]},
  {name:"Iguaçu (côté argentin) — Argentine",lat:-25.687,lng:-54.444,desc:"Les chutes d'Iguazú côté argentin permettent de marcher sur des passerelles à quelques mètres des chutes, dans les embruns permanents. La Garganta del Diablo (Gorge du Diable), deepest point des chutes à 82 mètres de hauteur, génère un brouillard si dense que la visibilité devient nulle à son aplomb.",hints:[
    {bc:"#3b0f0f",tc:"#fca5a5",l:"EXPERT",t:"Parc national Iguazú, 275 chutes dont Garganta del Diablo (82m), passerelles au ras de l'eau, coatis et tucans"},
    {bc:"#3d1a05",tc:"#fdba74",l:"DIFFICILE",t:"Province de Misiones, nord-est de l'Argentine, frontière brésilienne"},
    {bc:"#3a2008",tc:"#fde68a",l:"MOYEN",t:"Chutes d'Iguazú côté argentin, passerelles dans les chutes"},
    {bc:"#052e16",tc:"#86efac",l:"FACILE",t:"Province de Misiones, Argentine"},
    {bc:"#0c1a3e",tc:"#93c5fd",l:"TRÈS FACILE",t:"Argentine"}
  ]},
  {name:"Mendoza — Argentine (vignobles)",lat:-32.8908,lng:-68.8272,desc:"Le vignoble de Mendoza est irrigué depuis des siècles par un réseau de canaux incas ancestraux, toujours en usage. L'altitude de 800 à 1 500 mètres protège les vignes des maladies cryptogamiques et permet de produire des vins parmi les plus purs au monde.",hints:[
    ...
    {bc:"#3a2008",tc:"#fde68a",l:"MOYEN",t:"Vignobles de Mendoza, Malbec argentin au pied des Andes"},
    {bc:"#052e16",tc:"#86efac",l:"FACILE",t:"Province de Mendoza, piémont des Andes, Argentine"},
    {bc:"#0c1a3e",tc:"#93c5fd",l:"TRÈS FACILE",t:"Argentine"}
  ]},
  {name:"Rapa Nui — Île de Pâques (Ahu Tongariki)",lat:-27.1245,lng:-109.2778,desc:"Juste sous la surface de la mer entourant l'île de Pâques se trouvent des milliers de moaï submergés — les archéologues n'ont fouillé qu'une infime partie des fonds marins. Les têtes visibles sont en réalité des statues entières dont le corps est enfoui.",hints:[
    ...
    {bc:"#3d1a05",tc:"#fdba74",l:"DIFFICILE",t:"Côte est de Rapa Nui (Île de Pâques), territoire spécial du Chili, Pacifique Sud"},
    {bc:"#3a2008",tc:"#fde68a",l:"MOYEN",t:"Ahu Tongariki, 15 moaï face au lever du soleil, Île de Pâques"},
    {bc:"#052e16",tc:"#86efac",l:"FACILE",t:"Île de Pâques (Rapa Nui), Chili, Pacifique Sud"},
    {bc:"#0c1a3e",tc:"#93c5fd",l:"TRÈS FACILE",t:"Chili"}
  ]},
  ...
  {name:"Abel Tasman — Nouvelle-Zélande",lat:-40.85,lng:173,desc:"Le parc national Abel Tasman est le plus petit mais le plus visité de Nouvelle-Zélande. Son Abel Tasman Coast Track, l'un des 9 «Great Walks» néo-zélandais, longe des plages de granit doré et des laguons de marbre sur 51 km. Des otaries et des manchots à yeux jaunes y vivent sur les rochers face au détroit de Cook.",hints:[
    ...
    {bc:"#3a2008",tc:"#fde68a",l:"MOYEN",t:"Parc national Abel Tasman, plages d'or, côte du nord, Nouvelle-Zélande"},
    {bc:"#052e16",tc:"#86efac",l:"FACILE",t:"Île du Sud, Nouvelle-Zélande"},
    {bc:"#0c1a3e",tc:"#93c5fd",l:"TRÈS FACILE",t:"Nouvelle-Zélande"}
  ]},
  {name:"îles Cook — Rarotonga",lat:-21.2358,lng:-159.7777,desc:"Les Îles Cook furent les premières au monde à instituer «Te Maeva Nui» — une fête nationale de danse et de chant polynésien. Jacques Brel, qui vécut ses dernières années en Polynésie française voisine, fut profondément touché par ces traditions musicales du Pacifique.",hints:[
    ...
    {bc:"#3a2008",tc:"#fde68a",l:"MOYEN",t:"Rarotonga, île principale des Îles Cook, Pacifique Sud"},
    {bc:"#052e16",tc:"#86efac",l:"FACILE",t:"Îles Cook, Polynésie, Pacifique Sud"},
    {bc:"#0c1a3e",tc:"#93c5fd",l:"TRÈS FACILE",t:"Îles Cook (Nouvelle-Zélande)"}
  ]},
  {name:"Vanuatu — Yasur Volcano",lat:-19.5218,lng:169.4425,desc:"Le mont Yasur au Vanuatu est l'un des rares volcans où les visiteurs peuvent approcher à quelques mètres du bord du cratère lors des éruptions mineures. Les Kastom (autochtones) considèrent le volcan comme l'ancêtre de leur peuple et organisent des cérémonies traditionnelles à ses pieds.",hints:[
    ...
    {bc:"#3d1a05",tc:"#fdba74",l:"DIFFICILE",t:"Île de Tanna, province de Tafea, Vanuatu, Mélanésie, Pacifique Sud"},
    {bc:"#3a2008",tc:"#fde68a",l:"MOYEN",t:"Volcan Yasur, plus accessible au monde, Tanna, Vanuatu"},
    {bc:"#052e16",tc:"#86efac",l:"FACILE",t:"Vanuatu, Mélanésie, Pacifique Sud"},
    {bc:"#0c1a3e",tc:"#93c5fd",l:"TRÈS FACILE",t:"Vanuatu"}
  ]},
  {name:"Kakadu — Territoire du Nord, Australie",lat:-12.6784,lng:132.8371,desc:"Le parc national de Kakadu abrite des peintures rupestres aborigènes vieilles de 20 000 ans qui constituent un almanach vivant. Les artistes actuels continuent d'ajouter des peintures aux parois, maintenant une tradition ininterrompue depuis la préhistoire.",hints:[
    {bc:"#3b0f0f",tc:"#fca5a5",l:"EXPERT",t:"Plus grand parc national d'Australie (19 804 km²), art rupestre aborigène de 20 000 ans, Nourlangie Rock, crocodiles d'eau salée"},
    {bc:"#3d1a05",tc:"#fdba74",l:"DIFFICILE",t:"Territoire du Nord, à 150 km d'est de Darwin, Australie"},
    {bc:"#3a2008",tc:"#fde68a",l:"MOYEN",t:"Parc Kakadu, art rupestre et crocodiles, Territoire du Nord"},
    {bc:"#052e16",tc:"#86efac",l:"FACILE",t:"Territoire du Nord, Australie"},
    {bc:"#0c1a3e",tc:"#93c5fd",l:"TRÈS FACILE",t:"Australie"}
  ]},
  {name:"Blue Mountains — Nouvelle-Galles du Sud, Australie",lat:-33.719,lng:150.3113,desc:"Les Blue Mountains doivent leur teinte bleutée à la brume d'huile essentielle d'eucalyptus qui flotte en permanence dans l'air. Les 5 millions d'eucalyptus libèrent une huile volatile qui disperse la lumière bleue — un phénomène optique unique à cette région.",hints:[
    ...
    {bc:"#3d1a05",tc:"#fdba74",l:"DIFFICILE",t:"Tablelands des Blue Mountains, à 90 km à l'ouest de Sydney, Nouvelle-Galles du Sud"},
    {bc:"#3a2008",tc:"#fde68a",l:"MOYEN",t:"Blue Mountains, Three Sisters et brume bleue, Nouvelle-Galles du Sud"},
    {bc:"#052e16",tc:"#86efac",l:"FACILE",t:"Nouvelle-Galles du Sud, à l'ouest de Sydney, Australie"},
    {bc:"#0c1a3e",tc:"#93c5fd",l:"TRÈS FACILE",t:"Australie"}
  ]},
  {name:"Nambung — Australie-Occidentale (Pinnacles)",lat:-30.602,lng:115.157,desc:"Les Pinnacles d'Australie occidentale sont des formations calcaires créées depuis des coquillages marins fossilisés. Il y a 6 000 ans, cet endroit était au fond de l'océan. Des milliers de piliers émergent aujourd'hui du sable, certains de la taille d'un homme.",hints:[
  ...
  {name:"Similan Islands — Thaïlande",lat:8.65,lng:97.65,desc:"Les eaux des Similan, classées parmi les 10 meilleures plongées du monde par Cousteau, sont si claires que la visibilité peut atteindre 40 mètres. Les requins baleines, qui y sont régulièrement observés, sont les plus grands poissons du monde et se nourrissent uniquement de plancton.",hints:[
    ...
    {bc:"#052e16",tc:"#86efac",l:"FACILE",t:"Province de Phang Nga, mer d'Andaman, Thaïlande, archipel accessible uniquement en bateau depuis Khao Lak"},
    {bc:"#0c1a3e",tc:"#93c5fd",l:"TRÈS FACILE",t:"Îles Similan, Thaïlande"}
  ]},
  {name:"Phong Nha — Vietnam",lat:17.5472,lng:106.1286,desc:"La grotte de Son Doong est si grande qu'elle possède sa propre météo : nuages, brouillard matinal et précipitations internes. Des espèces animales endémiques y vivent, adaptées à l'obscurité perpétuelle. Seul un guide certifié peut accompagner les visiteurs — les places sont limitées à 1 000 par an.",hints:[
    ...
    {bc:"#052e16",tc:"#86efac",l:"FACILE",t:"Province côtière du centre Vietnam, grotte fluviale accessible en barque, forêt tropicale dense, à 50 km au nord-ouest de la capit"},
    {bc:"#0c1a3e",tc:"#93c5fd",l:"TRÈS FACILE",t:"Phong Nha, Vietnam — grotte fluviale du parc national Phong Nha-Kẻ Bàng, classée UNESCO"}
  ]},
  {name:"Bali — Indonésie (Tanah Lot)",lat:-8.6215,lng:115.0867,desc:"Bali est l'une des rares îles hindoues dans la mer d'îles islamiques qu'est l'Indonésie. Sa religion balinaise unique mêle hindouisme, bouddhisme et croyances animistes ancestrales. Chaque village possède au moins 3 temples — un pour les dieux, un pour les âmes et un pour les mauvais esprits.",hints:[
    ...
    {bc:"#3a2008",tc:"#fde68a",l:"MOYEN",t:"Temple hindou balinais perché sur un rocher marin érodé, crépuscule iconique, île aux rizières en terrasses"},
    {bc:"#052e16",tc:"#86efac",l:"FACILE",t:"Bali, Indonésie : temple sur rocher océanique à l'ouest de l'île, district de Tabanan, site le plus photographié de l'île"},
    {bc:"#0c1a3e",tc:"#93c5fd",l:"TRÈS FACILE",t:"Tanah Lot, Bali — temple hindou sur rocher marin, coucher de soleil célèbre"}
  ]},
  {name:"Ubud — Bali, Indonésie",lat:-8.5069,lng:115.2625,desc:"Bali est l'une des rares îles hindoues dans la mer d'îles islamiques qu'est l'Indonésie. Sa religion balinaise unique mêle hindouisme, bouddhisme et croyances animistes ancestrales. Chaque village possède au moins 3 temples — un pour les dieux, un pour les âmes et un pour les mauvais esprits.",hints:[
    ...
    {bc:"#052e16",tc:"#86efac",l:"FACILE",t:"Bali, Indonésie, dans les terres à ~25 km de Denpasar, entourée de rizières en terrasses et forêts tropicales"},
    {bc:"#0c1a3e",tc:"#93c5fd",l:"TRÈS FACILE",t:"Ubud, Bali — village artistique et culturel au cœur de l'île"}
  ]},
  {name:"Phuket — Thaïlande",lat:7.9519,lng:98.3381,desc:"Phuket fut dévastée par le tsunami de 2004 qui tua 8 000 personnes sur l'île. Sa reconstruction rapide et la modernisation de ses équipements touristiques transformèrent la catastrophe en opportunité économique — Phuket compte aujourd'hui plus de 10 millions de visiteurs par an.",hints:[
    {bc:"#3b0f0f",tc:"#fca5a5",l:"EXPERT",t:"Statue de 45m en marbre blanc de Birmanie, érigée en 2004 sur colline Nakkerd, style Maravija, île granitique au détroit de Malacc"},
    ...
    {bc:"#052e16",tc:"#86efac",l:"FACILE",t:"Île de Thaïlande en mer d'Andaman, vieille ville aux façades sino-portugaises, grand Bouddha blanc dominant la baie de Chalong"},
    {bc:"#0c1a3e",tc:"#93c5fd",l:"TRÈS FACILE",t:"Phuket, Thaïlande"}
  ]},
  {name:"Kazbegi — Géorgie",lat:42.6522,lng:44.6345,desc:"L'église de la Trinité de Gergeti, à 2 170 m d'altitude au-dessus de Kazbegi, fut utilisée comme cachette pour les trésors de l'église géorgienne lors des invasions mongoles. On y montait à cheval jusqu'aux années 1990 — aujourd'hui on peut y aller en 4x4.",hints:[
    ...
    {bc:"#052e16",tc:"#86efac",l:"FACILE",t:"Géorgie, vallée militaire géorgienne près de la frontière russe, village au pied d'un volcan de 5 047m"},
    {bc:"#0c1a3e",tc:"#93c5fd",l:"TRÈS FACILE",t:"Kazbegi, Géorgie — église de la Trinité de Gergeti face au mont Kazbek"}
  ]},
  {name:"Uplistsikhe — Géorgie",lat:41.9447,lng:44.2078,desc:"Uplistsikhe, «forteresse du Seigneur» en géorgien, est une ville rupestre vieille de 3 000 ans creusée dans le grès brun au-dessus de la rivière Kura. C'est l'une des plus anciennes villes de la Caucasie, habitée jusqu'au Xe siècle. On y trouve la plus ancienne salle d'audience à colonnes de la région.",hints:[
  ...
  {name:"Bakou — Azerbaïdjan (vieille ville)",lat:40.366,lng:49.8341,desc:"La vieille ville de Bakou, Icheri Sheher, fut fondée au Ve siècle. Sa Tour de la Vierge (XIIe siècle), visible de la mer Caspienne, n'a jamais servi de forteresse défensive — son rôle exact reste mystérieux. Bakou signifie «ville battue par le vent» en persan — des vents violents traversent la ville en permanence.",hints:[
    ...
    {bc:"#052e16",tc:"#86efac",l:"FACILE",t:"Capitale de l'Azerbaïdjan, quartier historique fortifié au bord de la mer Caspienne, tour cylindrique médiévale visible depuis le "},
    {bc:"#0c1a3e",tc:"#93c5fd",l:"TRÈS FACILE",t:"Bakou, vieille ville d'Icheri Sheher et sa Tour de la Vierge"}
  ]},
  {name:"Tbilissi — Géorgie (Mtskheta)",lat:41.8404,lng:44.721,desc:"Tbilissi signifie «ville des eaux chaudes» en géorgien. La ville fut fondée au Ve siècle par un roi qui, selon la légende, vit un faisan blessé guérir instantanément en entrant dans une source thermale chaude. Ces sources coulent encore aujourd'hui dans les bains soufrés du vieux Tbilissi.",hints:[
    ...
    {bc:"#052e16",tc:"#86efac",l:"FACILE",t:"Géorgie, vallée du fleuve Kura à 20 km au nord-ouest de la capitale, site archéologique et religieux majeur du Caucase"},
    {bc:"#0c1a3e",tc:"#93c5fd",l:"TRÈS FACILE",t:"Mtskheta, Géorgie, confluent Aragvi-Kura, cathédrale Sveti Tskhoveli"}
  ]},
  {name:"Vardzia — Géorgie",lat:41.389,lng:43.278,desc:"Le monastère rupestre de Vardzia, creusé dans la falaise volcanique au XIIe siècle par la reine Tamar, comprend 600 pièces sur 13 niveaux. Un tremblement de terre en 1283 effondra la façade de la montagne, révélant les cellules à l'air libre. Les fresques représentant la reine Tamar sont parmi les plus précieuses de l'art géorgien.",hints:[
    ...
    {bc:"#052e16",tc:"#86efac",l:"FACILE",t:"Sud de la Géorgie, vallée encaissée de la Mtkvari, près de la frontière turque, Samtskhe-Javakheti, monastère rupestre médiéval"},
    {bc:"#0c1a3e",tc:"#93c5fd",l:"TRÈS FACILE",t:"Vardzia, Géorgie — cité monastique troglodytique du XIIe s. creusée dans une falaise volcanique"}
  ]},
  {name:"Khor Virap — Arménie",lat:39.8316,lng:44.5673,desc:"Le mont Ararat, visible depuis Khor Virap, est considéré comme le berceau de la civilisation arménienne et le symbole national du pays — mais il se trouve en Turquie depuis 1921. Les Arméniens peuvent le voir depuis leur frontière sans pouvoir y accéder.",hints:[
    ...
    {bc:"#052e16",tc:"#86efac",l:"FACILE",t:"Arménie, plaine d'Ararat près de la frontière turque, monastère isolé sur une butte avec vue directe sur le mont Ararat"},
    {bc:"#0c1a3e",tc:"#93c5fd",l:"TRÈS FACILE",t:"Khor Virap, Arménie"}
  ]},
  {name:"Garni — Arménie",lat:40.1119,lng:44.729,desc:"Le temple de Garni est le seul édifice gréco-romain de tout le Caucase. Construit au Ier siècle ap. J.-C. par un roi arménien, il survécut à la christianisation du pays en 301 en étant transformé en bain royal puis en entrepôt.",hints:[
    ...
    {bc:"#052e16",tc:"#86efac",l:"FACILE",t:"Province de Kotayk, Arménie, sur un promontoire dominant la gorge de l'Azat, à 28 km à l'est d'Erevan"},
    {bc:"#0c1a3e",tc:"#93c5fd",l:"TRÈS FACILE",t:"Temple de Garni, Arménie, symbole national visible sur les billets de banque arméniens"}
  ]},
  {name:"Chefchaouen — Maroc",lat:35.1688,lng:-5.2636,desc:"La ville bleue du Maroc doit sa couleur à la communauté juive sépharade expulsée d'Espagne en 1492. Ils peignirent les murs en bleu, couleur symbolisant le ciel et la divinité dans la tradition juive. La pratique fut adoptée par toute la ville.",hints:[
    ...
    {bc:"#052e16",tc:"#86efac",l:"FACILE",t:"Maroc, province du Rif, ville célèbre pour ses ruelles bleues, près de Tétouan, entre mer et montagne"},
    {bc:"#0c1a3e",tc:"#93c5fd",l:"TRÈS FACILE",t:"Chefchaouen, la ville bleue du Maroc"}
  ]},
  {name:"Aït Benhaddou — Maroc",lat:31.0472,lng:-7.1322,desc:"Aït Benhaddou servit de décor à plus de 20 films et séries, dont Gladiator, Game of Thrones et Lawrence d'Arabie. Seules cinq familles habitent encore dans l'enceinte du ksar, le reste de la population ayant migré vers le village moderne.",hints:[
    {bc:"#3b0f0f",tc:"#fca5a5",l:"EXPERT",t:"Ksar de pisé du XIe s., tours défensives tronconiques, inscrit UNESCO 1987, décor de Lawrence d'Arabie et Gladiator, vallée de l'O"},
    ...
    {bc:"#052e16",tc:"#86efac",l:"FACILE",t:"Vallée de l'Ounila, pré-Sahara marocain, province d'Ouarzazate, ksar fortifié en pisé dominant la palmeraie"},
    {bc:"#0c1a3e",tc:"#93c5fd",l:"TRÈS FACILE",t:"Aït Benhaddou, ksar UNESCO, Maroc"}
  ]},
  {name:"Vallée du Dadès — Maroc",lat:31.4,lng:-5.975,desc:"Les gorges du Dadès, taillées par la rivière Dadès dans le Haut Atlas, sont surnommées «la Vallée des roses» car les villages voisins produisent 60% de la production mondiale d'eau de rose. Chaque mai, des fêtes de la rose célèbrent la floraison. La route sinueuse à travers les gorges est considérée comme l'une des plus spectaculaires du Maroc.",hints:[
    ...
    {bc:"#052e16",tc:"#86efac",l:"FACILE",t:"Gorges du Dadès, région Drâa-Tafilalet, sud du Maroc, route des Kasbahs reliant Ouarzazate à Tinghir"},
    {bc:"#0c1a3e",tc:"#93c5fd",l:"TRÈS FACILE",t:"Gorges du Dadès, Maroc, célèbres virages en épingle et falaises rouges au sud du Haut Atlas"}
  ]},
  {name:"Île de Djerba — Tunisie",lat:33.8076,lng:10.8451,desc:"Djerba est traditionnellement identifiée à l'île des Lotophages d'Homère, où Ulysse et ses compagnons mangèrent la fleur de lotus qui fit tout oublier. Elle abrite la synagogue El Ghriba, lieu de pèlerinage juif parmi les plus importants du monde, fondée au VIe siècle av. J.-C. selon la tradition.",hints:[
    ...
    {bc:"#052e16",tc:"#86efac",l:"FACILE",t:"Grande île du sud de la Tunisie, reliée par une digue au continent, connue pour ses maisons blanchies à la chaux et sa synagogue m"},
    {bc:"#0c1a3e",tc:"#93c5fd",l:"TRÈS FACILE",t:"Île tunisienne célèbre, destination balnéaire majeure avec synagogue El Ghriba, reliée par chaussée au continent"}
  ]},
  {name:"Tataouine — Tunisie (Ksour)",lat:32.9211,lng:10.4518,desc:"Les ksour (greniers collectifs fortifiés) du gouvernorat de Tataouine servirent de décors pour la planète Tatooine dans Star Wars. George Lucas tomba amoureux des ghorfas — les cellules voûtées empilées en tours — lors d'un repérage en 1975. La ville de Tataouine figura si directement dans le film que Lucas en adopta le nom.",hints:[
  ...
  {name:"Douz — Tunisie (Festival du Sahara)",lat:33.4558,lng:9.0244,desc:"Douz, «porte du Sahara», accueille chaque décembre le Festival international du Sahara — le plus grand rassemblement de culture nomade du monde. Courses de méhara, fantasias équestres, combats de lévriers sloughi et musique gnawa font de cet événement un plongeon dans la culture nomade du Maghreb.",hints:[
    ...
    {bc:"#052e16",tc:"#86efac",l:"FACILE",t:"Gouvernorat de Kébili, sud tunisien, oasis bordant le Grand Erg Oriental, point de départ des méharées sahariennes"},
    {bc:"#0c1a3e",tc:"#93c5fd",l:"TRÈS FACILE",t:"Douz, Tunisie, capitale du Sahara tunisien et ses célèbres dunes"}
  ]},
  {name:"Tipaza — Algérie",lat:36.589,lng:2.448,desc:"Tipaza, site archéologique sur la côte méditerranéenne algérienne, fut une cité punique puis romaine capitale. Albert Camus, Algérien de naissance, lui consacra ses premiers essais : «À Tipasa, j'apprenais que je portais en moi les ruines de cette cité». Il y revenait chaque fois qu'il doutait du sens de la vie.",hints:[
    ...
    {bc:"#052e16",tc:"#86efac",l:"FACILE",t:"Algérie, côte méditerranéenne à l'ouest d'Alger, site archéologique romain sur promontoire face à la mer"},
    {bc:"#0c1a3e",tc:"#93c5fd",l:"TRÈS FACILE",t:"Tipaza, Algérie"}
  ]},
  {name:"Volubilis — Maroc",lat:34.0736,lng:-5.5554,desc:"Les mosaïques de Volubilis, vieilles de 1 800 ans, sont encore en place dans les ruines à ciel ouvert — une rareté mondiale. La cité romaine fut abandonnée après le retrait de l'Empire au IIIe siècle et tomba dans l'oubli jusqu'au XIXe siècle.",hints:[
    ...
    {bc:"#052e16",tc:"#86efac",l:"FACILE",t:"Au Maroc, plaine entre montagnes du Rif et Moyen Atlas, près de la ville impériale de Meknès, accessible par la route de Moulay Id"},
    {bc:"#0c1a3e",tc:"#93c5fd",l:"TRÈS FACILE",t:"Volubilis, Maroc — ruines romaines les mieux conservées d'Afrique du Nord"}
  ]},
  {name:"Essaouira — Maroc",lat:31.5085,lng:-9.7595,desc:"Jimi Hendrix séjourna à Essaouira en 1969 et aurait voulu y construire un studio. La légende dit qu'il s'inspira de la ville et de sa musique gnaoua pour plusieurs compositions, dont «Castles Made of Sand».",hints:[
    ...
    {bc:"#052e16",tc:"#86efac",l:"FACILE",t:"Côte atlantique marocaine, province Essaouira, médina inscrite UNESCO, port de pêche aux barques bleues, skala dominant l'océan"},
    {bc:"#0c1a3e",tc:"#93c5fd",l:"TRÈS FACILE",t:"Essaouira, cité des vents du Maroc, remparts bleu et blanc face à l'Atlantique"}
  ]},
  {name:"Harar — Éthiopie",lat:9.3125,lng:42.1269,desc:"Harar est la 4e ville sainte de l'Islam et la capitale du café — l'Éthiopie est le berceau du café arabica. Ses 82 mosquées dans une vieille ville de moins d'1 km² en font l'une des villes islamiques les plus denses. Chaque soir, des nourrisseurs de hyènes attirent les hyènes sauvages à la nuit tombante — une tradition centenaire.",hints:[
    ...
    {bc:"#052e16",tc:"#86efac",l:"FACILE",t:"Est de l'Éthiopie, région Harari enclavée, vieille ville fortifiée du XVIe siècle aux ruelles colorées, proche de Dire Dawa"},
    {bc:"#0c1a3e",tc:"#93c5fd",l:"TRÈS FACILE",t:"Harar, Éthiopie orientale"}
  ]},
  {name:"Gorilles de Bwindi — Ouganda",lat:-1.05,lng:29.6667,desc:"Un permis pour tracker les gorilles de Bwindi coûte 700 dollars par personne. Cette somme, reversée directement aux communautés locales, a transformé la protection de la faune en ressource économique majeure et réduit considérablement le braconnage.",hints:[
    ...
    {bc:"#052e16",tc:"#86efac",l:"FACILE",t:"Parc national du sud-ouest de l'Ouganda, frontalier avec la RDC, célèbre pour le trekking des gorilles des montagnes"},
    {bc:"#0c1a3e",tc:"#93c5fd",l:"TRÈS FACILE",t:"Forêt impénétrable de Bwindi, Ouganda"}
  ]},
  {name:"Zanzibar — Tanzanie (plage Nungwi)",lat:-5.7294,lng:39.2976,desc:"Zanzibar est le lieu de naissance de Freddie Mercury, le chanteur de Queen. Sa maison natale dans Stone Town est devenue un lieu de pèlerinage pour les fans du monde entier. Il quitta l'île à 7 ans pour ne plus jamais y revenir.",hints:[
    ...
    {bc:"#052e16",tc:"#86efac",l:"FACILE",t:"Zanzibar, Tanzanie, extrémité nord de l'île principale, plage réputée pour ses eaux turquoise et son village de pêcheurs animé"},
    {bc:"#0c1a3e",tc:"#93c5fd",l:"TRÈS FACILE",t:"Plage de Nungwi, nord de Zanzibar"}
  ]}
];
