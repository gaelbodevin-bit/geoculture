const ROUNDS=[
  ...
  {name:"Château de Trakai — Lituanie",lat:54.6479,lng:24.9347,desc:"Le château de Trakai, bâti sur une île du lac Galv? au XIVe siècle, est le château insulaire le plus oriental d'Europe. Il fut la résidence du Grand-Duc Vytautas qui étendit la Lituanie jusqu'à la mer Noire, créant le plus grand État d'Europe médiévale.",hints:[
    ...
    {bc:"#3d1a05",tc:"#fdba74",l:"DIFFICILE",t:"Île du lac Galv?, ville de Trakai, à 28 km de Vilnius, Lituanie"},
  ...
  {name:"Auschwitz-Birkenau — Pologne",lat:50.0341,lng:19.1783,desc:"Auschwitz-Birkenau fut libéré le 27 janvier 1945 par l'armée soviétique. Ce jour est devenu la Journée internationale de la mémoire des victimes de l'Holocauste. Le site, classé UNESCO, reçoit plus de 2 millions de visiteurs par an.",hints:[
    ...
    {bc:"#3d1a05",tc:"#fdba74",l:"DIFFICILE",t:"Commune d'O?wi?cim, voïvodie de Petite-Pologne, à 60 km de Cracovie"},
  ...
  {name:"Ha Long Bay — Vietnam",lat:20.9101,lng:107.1839,desc:"La baie d'Ha Long compte 1 969 îlots calcaires formés il y a 500 millions d'années. Selon la légende vietnamienne, un dragon descendit du ciel en battant de la queue, ses coups créant les vallées et les baies. La baie abriterait aussi des grottes marines habitées par des villages flottants de pêcheurs.",hints:[
    ...
    {bc:"#3d1a05",tc:"#fdba74",l:"DIFFICILE",t:"Golfe du Tonkin, province de Qu?ng Ninh, nord-est du Vietnam"},
  ...
  {name:"Château de Malbork — Pologne",lat:54.0395,lng:19.0289,desc:"Le château de Malbork, construit en briques rouges sur une île de la rivière Nogat, est la plus grande forteresse médiévale du monde. Les Chevaliers Teutoniques l'érigèrent avec 4 millions de briques fabriquées dans des fours locaux.",hints:[
    ...
    {bc:"#3d1a05",tc:"#fdba74",l:"DIFFICILE",t:"Ville de Malbork, bord de la Nogat, Poméranie, nord de la Pologne, à 60 km de Gda?sk"},
  ...
  {name:"Hoi An — Vietnam",lat:15.8794,lng:108.335,desc:"La ville d'Hoi An était le port le plus important d'Asie du Sud-Est aux XVIe et XVIIe siècles, avant que son fleuve ne s'ensable. Son centre historique est si bien conservé qu'il semble suspendu dans le temps, à l'exception des lampions colorés qui s'allument chaque soir.",hints:[
    ...
    {bc:"#3d1a05",tc:"#fdba74",l:"DIFFICILE",t:"Province de Qu?ng Nam, centre du Vietnam, bord de la rivière Thu B?n"},
  ...
  {name:"Château de Bojnice — Slovaquie",lat:48.7796,lng:18.5793,desc:"Le château de Bojnice est le château le plus visité de Slovaquie. Il fut profondément remanié en style néo-gothique romantique au XIXe siècle par le comte János Pálffy qui voulait créer un décor de conte de fées. Ses sous-sols abritent une grotte préhistorique naturelle intégrée au complexe.",hints:[
    ...
    {bc:"#3d1a05",tc:"#fdba74",l:"DIFFICILE",t:"Commune de Bojnice, région de Tren?ín, Slovaquie occidentale, à 20 km de Prievidza"},
  ...
  {name:"Marché central — Budapest, Hongrie",lat:47.487,lng:19.06,desc:"La Grande Halle de Budapest fut inaugurée en 1897 et couvre 10 000 m². Ses galeries du premier étage proposent de la broderie hongroise et du paprika depuis un siècle. Son toit en tuiles vernissées Zsolnay est orné de motifs inspirés de l'art populaire magyar — une caractéristique de l'architecture Art Nouveau budapestois.",hints:[
    ...
    {bc:"#3d1a05",tc:"#fdba74",l:"DIFFICILE",t:"F?vám tér, Pest, bord du Danube, Budapest, Hongrie"},
  ...
  {name:"Lençóis Maranhenses — Brésil",lat:-2.4943,lng:-43.1291,desc:"Les dunes des Lençóis Maranhenses se forment et se déplacent chaque année. Malgré leur apparence désertique, les lacs qui s'y forment entre juin et septembre accueillent des piranhas, des raies et des tortues aquatiques — ramenés par les poissons lors des crues.",hints:[
    ...
    {bc:"#3a2008",tc:"#fde68a",l:"MOYEN",t:"Dunes de sable blanc aux lacs turquoise temporaires peuplés de piranhas, État du Maranhão, nord-est Brésil"},
