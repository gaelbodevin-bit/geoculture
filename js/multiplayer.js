...
// Countdown // Chaque client affiche le countdown localement.
...
function mpHandleRoundEnd(room) {
  ...
  // ?? Construire l'overlay style showInter var nb      = (room.options||{}).nbRounds||5;
  var next    = rIdx+1;
...
// Hook sur confirmGuess / timer écoulé de game.js // STRATÉGIE : on surcharge window.resolveRound
// En mode MP on bloque l'affichage solo (showInter) et on soumet à Firebase à la place.
// mpOnConfirm : appelé par game.js (confirmGuess/nextLevel) en mode MP // game.js a été patché pour appeler window.mpOnConfirm() au lieu de resolveRound()
