...
function mpOnDisbanded(room) {
  ...
  mp.roomCode=mp.playerId=mp.roomRef=null; mp.isHost=false;a// ?? GéoCulture Multijoueur – v3.1 (tous jouent ensemble, panel live, marqueurs)
import { initializeApp, getApps } from 'https://www.gstatic.com/firebasejs/10.11.0/firebase-app.js';
import { getDatabase, ref, set, get, onValue, off, update, remove }
  from 'https://www.gstatic.com/firebasejs/10.11.0/firebase-database.js';
...
window.mpLaunchNextRound  = mpLaunchNextRound;  mpCurrentRound=-1; mpAnswered=false; mpRoundActive=false; window._mpMode=false;
  setTimeout(function(){ if(typeof showMenu==='function') showMenu(); }, 2000);
}
