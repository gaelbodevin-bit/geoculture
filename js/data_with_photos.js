const ROUNDS=[
  {name:"Tour Eiffel — Paris, France",lat:48.8584,lng:2.2945,desc:"Symbole universel de la France, la Tour Eiffel fut d'abord critiquée comme une «verrue de fer» avant de devenir le monument payant le plus visité au monde avec 7 millions de visiteurs par an.",photo:"https://upload.wikimedia.org/wikipedia/commons/a/a8/Tour_Eiffel_Wikimedia_Commons.jpg",hints:[
  ...
  {name:"Acropole — Athènes, Grèce",lat:37.9715,lng:23.7267,desc:"Le Parthénon n'a jamais été achevé dans sa forme originale : ses colonnes légèrement inclinées vers l'intérieur et bombées créaient une illusion d'optique le faisant paraître parfaitement droit.",photo:"https://upload.wikimedia.org/wikipedia/commons/3/34/Lindos_Rhodes_3.jpg",hints:[
  ...
  {name:"Château de Versailles — France",lat:48.8049,lng:2.1204,desc:"Versailles consomma 6% du budget total du royaume sous Louis XIV. Ses jardins de 800 hectares nécessitaient 1 200 personnes pour leur entretien. Le roi se levait à 8h30 dans une cérémonie appelée le «Lever» : 200 courtisans s'y bousculaient pour tenir sa chemise ou lui présenter sa perruque.",photo:"https://upload.wikimedia.org/wikipedia/commons/0/04/Vue_a%C3%A9rienne_du_domaine_de_Versailles_par_ToucanWings_-_Creative_Commons_By_Sa_3.0_-_083.jpg",hints:[
  ...
  {name:"Mont Fuji — Japon",lat:35.3606,lng:138.7274,desc:"Le Fuji est considéré comme sacré depuis des siècles — les femmes n'avaient pas le droit de l'escalader jusqu'en 1868. Chaque été, près de 200 000 personnes font l'ascension dont beaucoup de nuit pour voir le lever du soleil.",photo:"https://upload.wikimedia.org/wikipedia/commons/c/cd/Fuji_Kawaguchi_357.JPG",hints:[
  ...
  {name:"Machu Picchu — Pérou",lat:-13.1631,lng:-72.545,desc:"Machu Picchu fut construit sans roue, sans fer et sans écriture. Ses murs en pierre sèche résistent aux séismes car chaque bloc est légèrement arrondi, permettant aux pierres de «danser» lors des tremblements de terre.",photo:"https://upload.wikimedia.org/wikipedia/commons/1/13/Before_Machu_Picchu.jpg",hints:[
  ...
  {name:"Sagrada Família — Barcelone",lat:41.4036,lng:2.1744,desc:"Gaudí consacra les 43 dernières années de sa vie à cette cathédrale. Renversé par un tramway en 1926, il fut enterré dans sa propre église. La construction, financée uniquement par les entrées des visiteurs, devrait s'achever en 2026.",photo:"https://upload.wikimedia.org/wikipedia/commons/7/78/SF_maig_2026.jpg",hints:[
  ...
  {name:"Palais d'été — Pékin, Chine",lat:39.9999,lng:116.2755,desc:"Le Palais d'Été de Pékin fut pillé et incendié par les troupes franco-britanniques en 1860. L'impératrice Cixi le fit entièrement reconstruire en 1888 en détournant les fonds destinés à la modernisation de la marine militaire chinoise — une décision qui contribua à la défaite lors de la guerre sino-japonaise.",photo:"https://upload.wikimedia.org/wikipedia/commons/1/1c/SummerPalace2.jpg",hints:[
  ...
  {name:"Patagonie — Argentine",lat:-50.9423,lng:-73.4068,desc:"La Patagonie couvre 900 000 km² — soit une surface plus grande que la France et l'Espagne réunies. Avec seulement 2 habitants au km², c'est l'une des régions les moins peuplées de la planète, habitée surtout par des guanacos et des condors.",photo:"https://upload.wikimedia.org/wikipedia/commons/a/a7/Pat_map.PNG",hints:[
  ...
  {name:"Serengeti — Tanzanie",lat:-2.3333,lng:34.8333,desc:"La Grande Migration du Serengeti est guidée uniquement par l'instinct collectif et la détection de l'herbe fraîche par les gnous. Aucun animal ne «dirige» le mouvement — c'est un phénomène d'intelligence collective qui déplace 1,5 million d'animaux sur 1 800 km.",photo:"https://upload.wikimedia.org/wikipedia/commons/4/48/Tanzania-_Serengeti_National_Park-_elefante.jpg",hints:[
  ...
  {name:"Monument Valley — Arizona/Utah, USA",lat:36.9991,lng:-110.0985,desc:"Monument Valley est la propriété privée de la Nation Navajo qui en contrôle strictement le tourisme. Les formations rocheuses rouges, appelées «buttes», sont si emblématiques de l'Ouest américain qu'elles ont servi de décor à des dizaines de westerns de John Ford.",photo:"https://upload.wikimedia.org/wikipedia/commons/c/cf/Wfm_monument_valley_annotated.jpg",hints:[
  ...
  {name:"Parc de Yellowstone — USA (Grand Prismatic)",lat:44.5248,lng:-110.8381,desc:"Le Grand Prismatic Spring de Yellowstone est la plus grande source chaude des États-Unis et la troisième du monde. Ses anneaux colorés (bleu, vert, jaune, orange, rouge) résultent de différentes espèces de bactéries adaptées à des températures précises, de 93°C au centre à 50°C sur les bords.",hints:[
    {bc:"#3b0f0f",tc:"#fca5a5",l:"EXPERT",t:"Grand Prismatic Spring, plus grande source thermale du parc (91m de diamètre), couleurs dues aux bactéries thermophiles"},
    ...
    {bc:"#052e16",tc:"#86efac",l:"FACILE",t:"Le Parc de Yellowstone en USA (Grand Prismatic)"}
  ]},
  ...
  {name:"Château de Windsor — Angleterre, Royaume-Uni",lat:51.4839,lng:-0.6044,desc:"Le château de Windsor possède la plus longue allée plantée d'arbres au monde : the Long Walk, une avenue de 4,8 km bordée de platanes et de marronniers. Elle fut plantée en 1685 et constitue l'axe central du Grand Parc de Windsor.",hints:[
    ...
    {bc:"#3a2008",tc:"#fde68a",l:"MOYEN",t:"Plus grande résidence royale habitée au monde, forteresse médiévale, Berkshire, Angleterre"},
    {bc:"#052e16",tc:"#86efac",l:"FACILE",t:"Le Château de Windsor à Angleterre, Royaume-Uni"}
  ]},
  ...
  {name:"Sagrada Família — Vue aérienne, Barcelone",lat:41.4036,lng:2.1745,desc:"Gaudí consacra les 43 dernières années de sa vie à cette cathédrale. Renversé par un tramway en 1926, il fut enterré dans sa propre église. La construction, financée uniquement par les entrées des visiteurs, devrait s'achever en 2026.",photo:"https://upload.wikimedia.org/wikipedia/commons/7/78/SF_maig_2026.jpg",hints:[
    ...
    {bc:"#052e16",tc:"#86efac",l:"FACILE",t:"Le Sagrada Família à Vue aérienne, Barcelone"}
  ]},
  ...
  {name:"Parc national de Doñana — Espagne",lat:36.996,lng:-6.342,desc:"Doñana est la plus grande réserve naturelle d'Europe occidentale et le principal refuge du lynx ibérique — l'un des félins les plus menacés du monde avec 400 individus. Les flamants roses, aigrettes et pygargues y nichent par milliers. Ses dunes mobiles avancent de 5 à 6 mètres par an, englobant progressivement la forêt de pins.",photo:"https://upload.wikimedia.org/wikipedia/commons/e/e6/El_Acebuche.jpg",hints:[
  ...
  {name:"Grand-Place — Bruxelles, Belgique",lat:50.8467,lng:4.3525,desc:"La Grand-Place de Bruxelles fut décrite par Victor Hugo comme «le théâtre le plus beau du monde». Sa Maison du Roi et ses guildes de corporations dorées datent du XVe siècle. Chaque été impair, elle est recouverte d'un tapis de 700 000 fleurs fraîches disposées en motifs géométriques par des fleuristes belges et hollandais.",photo:"https://upload.wikimedia.org/wikipedia/commons/2/26/Grand-Place%2C_Brussels_-_panorama%2C_June_2018.jpg",hints:[
  ...
  {name:"Pont Charles — Prague, Rép. Tchèque",lat:50.0865,lng:14.4114,desc:"Le pont Charles de Prague fut construit selon la numérologie médiévale : la première pierre fut posée le 9 juillet 1357 à 5h31 du matin, formant la séquence palindromique 1357 9 7 5 31. Cette date «magique» devait assurer la solidité éternelle du pont.",hints:[
    {bc:"#3b0f0f",tc:"#fca5a5",l:"EXPERT",t:"Karl?v most, construit de 1357 à 1402 par Charles IV, 516m, 30 statues baroques, première pierre posée le 9 juillet 1357"},
    {bc:"#3d1a05",tc:"#fdba74",l:"DIFFICILE",t:"Enjambant la Vltava entre Malá Strana et Staré M?sto, Prague, Tchéquie"},
    {bc:"#3a2008",tc:"#fde68a",l:"MOYEN",t:"Pont médiéval aux 30 statues baroques, symbole de Prague"},
    {bc:"#052e16",tc:"#86efac",l:"FACILE",t:"Le Pont Charles à Prague, Rép. Tchèque"}
  ]},
  ...
  {name:"Cathédrale de Chartres — France",lat:48.4474,lng:1.4877,desc:"La cathédrale de Chartres est l'une des rares à avoir conservé ses vitraux médiévaux d'origine. Pendant la Seconde Guerre mondiale, les Chartranais déposèrent les 176 vitraux et les enfouirent dans des caisses dans des caves pour les protéger des bombardements.",hints:[
    ...
    {bc:"#052e16",tc:"#86efac",l:"FACILE",t:"La Cathédrale de Chartres en France"}
  ]},
  ...
  {name:"Gorges du Verdon — France",lat:43.721,lng:6.344,desc:"Le Verdon doit ses eaux d'un turquoise irréel aux particules de calcaire en suspension qui réfractent la lumière bleue. La gorge, jusqu'à 700 mètres de profondeur, ne fut explorée pour la première fois qu'en 1905 par le géographe Édouard-Alfred Martel.",photo:"https://upload.wikimedia.org/wikipedia/commons/f/f9/Verdon_Gorge_1.jpg",hints:[
  ...
  {name:"Abbaye du Mont Saint-Michel — Normandie",lat:48.6361,lng:-1.5115,desc:"La baie du Mont-Saint-Michel possède le coefficient de marée le plus fort d'Europe continentale. En 1879, la construction d'une digue pour relier le Mont au continent accéléra l'envasement de la baie. La digue fut démantelée et remplacée par un pont en 2014 pour laisser circuler les eaux.",hints:[
    ...
    {bc:"#052e16",tc:"#86efac",l:"FACILE",t:"L'Abbaye du Mont Saint-Michel en Normandie"}
  ]},
  ...
  {name:"Château de Fontainebleau — France",lat:48.4023,lng:2.7014,desc:"Château de Fontainebleau est un lieu historique remarquable situé en Europe.",photo:"https://upload.wikimedia.org/wikipedia/commons/8/8b/1-_%28c%29_chateau_de_fontainebleau.jpg",hints:[
  ...
  {name:"Tours Petronas — Kuala Lumpur, Malaisie",lat:3.1579,lng:101.7119,desc:"Les tours Petronas furent les plus hautes du monde de 1998 à 2004. Conçues par César Pelli, leur plan au sol dessine deux étoiles à 8 branches entrelacées — un symbole islamique. Le skybridge du 41e étage ne repose pas sur les tours elles-mêmes mais sur ses propres fondations, pouvant glisser de 30 cm lors des balancements.",photo:"https://upload.wikimedia.org/wikipedia/commons/thumb/b/bc/Petronas_Towers_Logo.svg/langfr-330px-Petronas_Towers_Logo.svg.png",hints:[
  ...
  {name:"Varanasi — Inde",lat:25.3176,lng:83.0062,desc:"Le Gange à Varanasi est si sacré que les Hindous croient qu'y mourir assure la libération du cycle des renaissances. Des milliers de personnes viennent mourir à Varanasi chaque année, confiés aux «Dom» — les intouchables qui veillent sur les crémations du ghat Manikarnika, actives 24h/24 depuis des siècles.",hints:[
    ...
    {bc:"#3a2008",tc:"#fde68a",l:"MOYEN",t:"Plus sainte ville de l'hindouisme, ghats de crémation sur le Gange, Uttar Pradesh"},
    {bc:"#052e16",tc:"#86efac",l:"FACILE",t:"Le Varanasi en Inde"}
  ]},
  ...
  {name:"Île de Gorée — Sénégal (Maison des Esclaves)",lat:14.6689,lng:-17.3983,desc:"Gorée était si prospère grâce au commerce des esclaves que les marchands européens se disputaient sa possession pendant deux siècles. L'île changea de mains 7 fois entre Portugais, Hollandais, Anglais et Français.",hints:[
    ...
    {bc:"#3d1a05",tc:"#fdba74",l:"DIFFICILE",t:"Île d'une grande baie ouest-africaine, Maison des Esclaves, face au continent"},
    {bc:"#3a2008",tc:"#fde68a",l:"MOYEN",t:"Maison des Esclaves de Gorée, mémorial de la traite négrière, Sénégal"},
    {bc:"#052e16",tc:"#86efac",l:"FACILE",t:"L'Île de Gorée au Sénégal (Maison des Esclaves)"}
  ]},
  ...
  {name:"NASA Kennedy — Cap Canaveral, USA",lat:28.5721,lng:-80.648,desc:"Le Kennedy Space Center est l'un des sites de lancement les plus actifs du monde, avec 50 à 60 lancements par an aujourd'hui. Sa Vehicle Assembly Building (160 m de haut) est si grande que des nuages peuvent se former à l'intérieur par temps humide. Depuis Apollo 11 en 1969, plus de 150 missions habitées y ont pris leur envol.",hints:[
    ...
    {bc:"#052e16",tc:"#86efac",l:"FACILE",t:"Le NASA Kennedy à Cap Canaveral, USA"}
  ]},
  ...
  {name:"Parc national de Zion — Utah, USA",lat:37.2982,lng:-113.0263,desc:"Le parc de Zion est le résultat de 240 millions d'années d'érosion de grès Navajo par la rivière Virgin. Sa «Narrows», gorge de 800 mètres de large et 60 mètres de profondeur, se parcourt en marchant dans l'eau. La randonnée Angels Landing, avec ses chaînes d'acier dans la falaise, nécessite un permis tiré au sort depuis 2022.",photo:"https://upload.wikimedia.org/wikipedia/commons/9/9e/Angels_Landing.jpg",hints:[
  ...
  {name:"La Havane — Cuba",lat:23.1136,lng:-82.3666,desc:"La Havane abrite le plus grand ensemble d'architecture coloniale baroque des Amériques. Ses vieilles voitures américaines des années 1950, embargo oblige, sont toujours en circulation — entretenues par des mécaniciens cubains qui fabriquent eux-mêmes les pièces manquantes. Le Malecón, promenade bordant l'océan, est le salon à ciel ouvert de la ville.",photo:"https://upload.wikimedia.org/wikipedia/commons/thumb/8/8b/Flag_of_City_of_Havana.svg/langfr-330px-Flag_of_City_of_Havana.svg.png",hints:[
  ...
  {name:"Chichen Itza — Cenote Sagrado, Mexique",lat:20.6829,lng:-88.5686,desc:"La cénote sacrée de Chichen Itza fut le théâtre de sacrifices mayas pendant des siècles. Au fond de ce puits de 60 mètres de diamètre, les archéologues retrouvèrent en 1904 des ossements de victimes, des bijoux de jade et des objets d'or. L'explorateur Edward Thompson les remontait à la grue depuis son hacienda privée.",hints:[
    ...
    {bc:"#3d1a05",tc:"#fdba74",l:"DIFFICILE",t:"Site archéologique maya, nord d'une péninsule calcaire tropicale, pyramide à 9 niveaux"},
    {bc:"#3a2008",tc:"#fde68a",l:"MOYEN",t:"Cenote sacré des Mayas à Chichén Itzá, péninsule du Yucatán"},
    {bc:"#052e16",tc:"#86efac",l:"FACILE",t:"Le Chichen Itza à Cenote Sagrado, Mexique"}
  ]},
  ...
  {name:"Îles Fidji — Pacifique Sud",lat:-17.7134,lng:178.065,desc:"Les Fidji comptent 330 îles dont 110 habitées. Leur culture du kava — boisson à base de racine de poivrier polynésien — est centrale à leur vie sociale. Chaque visiteur est accueilli par une cérémonie du kava. L'eau des Fidji fut classée source d'eau minérale la plus pure au monde pendant des années.",photo:"https://upload.wikimedia.org/wikipedia/commons/thumb/f/f6/Fiji_on_the_globe_%28small_islands_magnified%29_%28Polynesia_centered%29.svg/langfr-330px-Fiji_on_the_globe_%28small_islands_magnified%29_%28Polynesia_centered%29.svg.png",hints:[
  ...
  {name:"Arène de Vérone — Italie",lat:45.4385,lng:10.9942,desc:"L'arène de Vérone, amphithéâtre romain du Ier siècle, est l'un des trois mieux conservés du monde avec ses galeries extérieures quasi intactes. Depuis 1913, elle accueille chaque été le festival d'opéra le plus populaire au monde — 22 000 spectateurs munis de bougies assistent à des représentations de Verdi en plein air.",photo:"https://upload.wikimedia.org/wikipedia/commons/5/54/Italy_-_Verona_-_Arena.jpg",hints:[
  ...
  {name:"Cirque de Gavarnie — France",lat:42.7286,lng:0.0114,desc:"La grande cascade de Gavarnie, avec ses 422 mètres, est la plus haute de France. Le cirque fut décrit par Victor Hugo comme «le plus grand édifice que le Dieu ait fait» lors de son passage en 1843.",hints:[
    ...
    {bc:"#052e16",tc:"#86efac",l:"FACILE",t:"Le Cirque de Gavarnie en France"}
  ]},
  ...
  {name:"Musée d'Orsay — Paris, France",lat:48.86,lng:2.3266,desc:"La transformation de la gare d'Orsay en musée préserva un bâtiment condamné à la démolition. En 1970, un promoteur immobilier avait déjà acheté la gare pour la remplacer par un hôtel. Des artistes et intellectuels menèrent une campagne de sauvegarde qui aboutit en 1986.",photo:"https://upload.wikimedia.org/wikipedia/fr/7/73/Logo_mus%C3%A9e_d%27Orsay.png",hints:[
  ...
  {name:"Big Ben — Westminster, Royaume-Uni",lat:51.5007,lng:-0.1246,desc:"Big Ben ne désigne pas la tour mais la cloche de 13,7 tonnes qu'elle abrite. Silenciée pour restauration de 2017 à 2022, elle a retenti à nouveau pour le couronnement de Charles III en mai 2023.",photo:"https://upload.wikimedia.org/wikipedia/commons/4/43/Elizabeth_Tower%2C_June_2022.jpg",hints:[
    ...
    {bc:"#052e16",tc:"#86efac",l:"FACILE",t:"Le Big Ben à Westminster, Royaume-Uni"}
  ]},
  ...
  {name:"Cathédrale de Cologne — Rhénanie, Allemagne",lat:50.9413,lng:6.9583,desc:"La cathédrale de Cologne fut construite sur 632 ans (1248-1880) — la plus longue construction d'une cathédrale gothique. Ses flèches jumelles de 157 mètres furent le bâtiment le plus haut du monde de 1880 à 1884. Elle abritent les reliques supposées des Rois Mages, apportées de Milan en 1164 — ce qui en fit le plus grand pèlerinage médiéval d'Europe du Nord.",hints:[
    ...
    {bc:"#052e16",tc:"#86efac",l:"FACILE",t:"La Cathédrale de Cologne à Rhénanie, Allemagne"}
  ]},
  ...
  {name:"Abbaye de Westminster — Londres",lat:51.4994,lng:-0.1273,desc:"L'abbaye de Westminster est le lieu de couronnement de tous les souverains britanniques depuis Guillaume le Conquérant en 1066. Dix-sept monarques y sont enterrés. La Pierre du Destin, sur laquelle les rois d'Écosse étaient couronnés depuis -840, y fut intégrée lors du couronnement de Charles III en 2023.",photo:"https://upload.wikimedia.org/wikipedia/commons/8/8b/Westminster_Abbey_St_Peter.jpg",hints:[
  ...
  {name:"Château de Windsor — Royaume-Uni",lat:51.4839,lng:-0.6044,desc:"Le château de Windsor possède la plus longue allée plantée d'arbres au monde : the Long Walk, une avenue de 4,8 km bordée de platanes et de marronniers. Elle fut plantée en 1685 et constitue l'axe central du Grand Parc de Windsor.",photo:"https://upload.wikimedia.org/wikipedia/commons/8/8f/Windsor_Castle_at_Sunset_-_Nov_2006.jpg",hints:[
  ...
  {name:"Qutb Minar — Delhi, Inde",lat:28.5245,lng:77.1855,desc:"La colonne de fer du Qutb Minar résiste à la rouille depuis 1 600 ans grâce à sa composition unique : elle contient 0,15% de phosphore qui forme une couche protectrice d'hydrogène phosphate de fer. Cet acier damas naturel reste un mystère pour les métallurgistes modernes.",photo:"https://upload.wikimedia.org/wikipedia/commons/5/57/Qutub_Minar_in_Delhi_03-2016.jpg",hints:[
  ...
  {name:"Osaka Castle — Osaka, Japon",lat:34.6873,lng:135.5261,desc:"Le château d'Osaka est entouré du plus grand marché de cerisiers en fleur du Kansai. Sa fondation fut réalisée avec des pierres géantes portant des inscriptions — les daimyos rivaux prouvaient leur loyauté en contribuant des blocs de pierre. La plus grande pierre, «Higo no Ishi», pèse 130 tonnes.",hints:[
    {bc:"#3b0f0f",tc:"#fca5a5",l:"EXPERT",t:"?saka-j?, construit par Toyotomi Hideyoshi en 1583, tour de 5 étages, cerisiers du Nishinomaru Garden"},
    {bc:"#3d1a05",tc:"#fdba74",l:"DIFFICILE",t:"Ch??-ku, parc du château d'Osaka, rive de l'Okawa, Osaka"},
    {bc:"#3a2008",tc:"#fde68a",l:"MOYEN",t:"Château d'Osaka de Toyotomi Hideyoshi, Japon"},
    {bc:"#052e16",tc:"#86efac",l:"FACILE",t:"L'Osaka Castle à Osaka, Japon"}
  ]},
  ...
  {name:"Canal de Corinthe — Grèce",lat:37.9378,lng:22.987,desc:"Le canal de Corinthe, long de 6,3 km et large de seulement 21 mètres, fut creusé de 1882 à 1893 dans le calcaire de l'isthme. L'idée remontait à l'Antiquité — Néron en creusa lui-même les premiers coups de pioche en 67 ap. J.-C. avant d'abandonner. Ses parois de 90 mètres donnent aux bateaux l'impression de naviguer dans un gouffre.",photo:"https://upload.wikimedia.org/wikipedia/commons/0/01/Bateau_traversant_le_canal_de_corinthe.jpg",hints:[
  ...
  {name:"Delphes — Grèce",lat:38.4824,lng:22.501,desc:"L'oracle de Delphes était si influent que les Grecs et les rois étrangers venaient le consulter avant toute décision majeure. La Pythie rendait ses oracles dans une transe causée par des vapeurs géologiques — des chercheurs ont confirmé en 2001 l'existence de failles émettant de l'éthylène sous le temple d'Apollon.",photo:"https://upload.wikimedia.org/wikipedia/commons/d/d4/Delphi_Composite.jpg",hints:[
  ...
  {name:"Mer Morte — Israël/Jordanie",lat:31.559,lng:35.4732,desc:"La mer Morte, à 430 mètres sous le niveau de la mer, est le point le plus bas de la surface terrestre. Sa salinité de 34% (contre 3,5% pour les océans) rend la nage impossible — les baigneurs flottent naturellement sans effort. Elle rétrécit de 1 mètre par an à cause des détournements des eaux du Jourdain.",photo:"https://upload.wikimedia.org/wikipedia/commons/c/cd/Dode_zee.jpg",hints:[
  ...
  {name:"Hallstatt — Autriche",lat:47.5622,lng:13.6493,desc:"Le cimetière de Hallstatt est si petit que les os exhumés après 10-12 ans sont décorés de motifs et placés dans une chapelle à crânes — la Beinhaus. Cette tradition unique perpétue la mémoire des défunts dans une ville où les morts dépassent les vivants.",photo:"https://upload.wikimedia.org/wikipedia/commons/b/b0/Hallstatt_-_Zentrum_.JPG",hints:[
  ...
  {name:"Vallée de la So?a — Slovénie",lat:46.34,lng:13.65,desc:"La Statue de la Liberté fut offerte par la France mais les Américains durent financer eux-mêmes son piédestal. Joseph Pulitzer lança une collecte publique dans son journal, récoltant 100 000 dollars en moins de six mois.",hints:[
  ...
  {name:"Château d'If — Marseille, France",lat:43.2796,lng:5.325,desc:"Le château d'If, forteresse construite en 1524 sur une île du large de Marseille, abrita les prisonniers d'État les plus dangereux, dont le «masque de fer». Alexandre Dumas en fit la prison fictive du Comte de Monte-Cristo — le roman lui valut un tel succès que des touristes vinrent chercher «la cellule de Dantès».",photo:"https://upload.wikimedia.org/wikipedia/commons/e/e0/Chateau_d%27If_view.jpg",hints:[
  ...
  {name:"Marrakech — Maroc (Djemaa el-Fna)",lat:31.6258,lng:-7.9892,desc:"La place Djemaa el-Fna de Marrakech est classée par l'UNESCO comme patrimoine immatériel de l'humanité — une première pour un espace public. Elle se transforme chaque soir en gigantesque restaurant en plein air avec des dizaines de stands de cuisine.",photo:"https://upload.wikimedia.org/wikipedia/commons/9/9c/Pavillon_Menarag%C3%A4rten.jpg",hints:[
  ...
  {name:"Gondar — Éthiopie (Fasiladas)",lat:12.603,lng:37.464,desc:"Gondar, surnommée «Camelot africain», abrite le Fasil Ghebbi — enceinte royale du XVIIe siècle comprenant 5 châteaux. L'influence des architectes indiens, arabes et portugais crée un style architectural unique. La piscine de Fasiladas se remplit une fois par an pour le festival Timkat (Épiphanie) — des milliers de fidèles s'y plongent.",photo:"https://upload.wikimedia.org/wikipedia/commons/3/34/Gonder_from_the_Goha_hotel.jpg",hints:[
  ...
  {name:"Chichen Itza — Mexique (cenote)",lat:20.6776,lng:-88.5681,desc:"La grande cénote sacrée de Chichen Itza livra lors de fouilles au XXe siècle des dizaines de squelettes, bijoux de jade et objets en or — confirmant les sacrifices mayas. On estime que des milliers d'offrandes reposent encore au fond inaccessible du puits.",hints:[
    ...
    {bc:"#3d1a05",tc:"#fdba74",l:"DIFFICILE",t:"Cité maya d'une péninsule calcaire tropicale, pyramide à 9 niveaux"},
    {bc:"#3a2008",tc:"#fde68a",l:"MOYEN",t:"Puits sacré de 60 m de diamètre, lieu de sacrifices mayas et offrandes d'or, site maya du Yucatán"},
    {bc:"#052e16",tc:"#86efac",l:"FACILE",t:"Le Chichen Itza au Mexique (cenote)"}
  ]},
  ...
  {name:"Iguaçu (côté argentin) — Argentine",lat:-25.687,lng:-54.444,desc:"Les chutes d'Iguazú côté argentin permettent de marcher sur des passerelles à quelques mètres des chutes, dans les embruns permanents. La Garganta del Diablo (Gorge du Diable), deepest point des chutes à 82 mètres de hauteur, génère un brouillard si dense que la visibilité devient nulle à son aplomb.",hints:[
    ...
    {bc:"#3d1a05",tc:"#fdba74",l:"DIFFICILE",t:"Province subtropicale, nord-est d'un pays sud-américain, frontière internationale"},
    {bc:"#3a2008",tc:"#fde68a",l:"MOYEN",t:"Chutes d'Iguazú côté argentin, passerelles dans les chutes"},
    {bc:"#052e16",tc:"#86efac",l:"FACILE",t:"L'Iguaçu (côté argentin) en Argentine"}
  ]},
  ...
  {name:"Garni — Arménie",lat:40.1119,lng:44.729,desc:"Le temple de Garni est le seul édifice gréco-romain de tout le Caucase. Construit au Ier siècle ap. J.-C. par un roi arménien, il survécut à la christianisation du pays en 301 en étant transformé en bain royal puis en entrepôt.",photo:"https://upload.wikimedia.org/wikipedia/commons/5/54/Garni_Village.JPG",hints:[
