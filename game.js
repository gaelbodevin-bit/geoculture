const BASE_PTS=[0,500,1000,1500,2000,3000];
const MAX_DIST=2000;
const CIRC=2*Math.PI*42;
const T=30;

let map,playerMarker,targetMarker,lineLayer;
let roundList=[],curR=0,curL=0,total=0,timeLeft=T,tiv=null;
let playerPos=null,gameActive=false,confirming=false,roundScores=[];
...
const FLASH_COLORS=['#ef4444','#f97316','#eab308','#22c55e','#3b82f6'];
const FLASH_LABELS=['Expert','Difficile','Moyen','Facile','Très facile'];
